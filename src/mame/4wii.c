...
//N DRIVER( shootbul )  /* (c) 1985 Bally Midway */
//- DRIVER( piranha )   /* GL */
//- DRIVER( piranhao )  /* GL */
...
//N DRIVER( bwcasino )  /* (c) 1983 Epos Coropration */
...
//N DRIVER( rocktrv2 )  /* (c) 1986 Triumph Software Inc */
//N DRIVER( bigbucks )  /* (c) 1986 Dynasoft Inc. */
//- DRIVER( mschamp )   /* hack */
...
//- DRIVER( theglob3 )  /* (c) 1983 */
    DRIVER( igmo )      /* (c) 1984 */
//N DRIVER( dealer )    /* (c) 198? */
//# DRIVER( revenger )  /* (c) 1984 */
#endif

    /* "Galaxian hardware" games */
#ifdef __GAME__NAMCO_KONAMI__
...
//N DRIVER( hunchbkg )  /* (c) 1983 Century */
//# DRIVER( harem )     /* [1983] I.G.R. */
//- DRIVER( tazzmang )  /* bootleg */
//N DRIVER( racknrol )  /* (c) 1986 Status (Shinkia license) (Senko Kit) */
...
//N DRIVER( luctoday )  /* 1980 Sigma */
//N DRIVER( chewing )   /* ?? unknown */
...
//N DRIVER( tdpgal )    /* 1983 Design Labs / Thomas Automatics */
...
//N DRIVER( 800fath )   /* (c) 1981 Amenip + U.S. Billiards license */
...
//N DRIVER( hustler )   /* GX343 (c) 1981 Konami */
...
//N DRIVER( hyhoo )     /* (c) 1987 */
//N DRIVER( hyhoo2 )    /* (c) 1987 */
//N DRIVER( jangou )    /* (c) 1983 */
//N DRIVER( macha )     /* (c) 1983 Logitec */
    /* Jangou Night   *//* (c) 1983 */
//N DRIVER( jngolady )  /* (c) 1984 */
//N DRIVER( cntrygrl )  /* (c) 1984 Royal Denshi */
...
//N DRIVER( pastelg )   /* (c) 1985 */
//N DRIVER( 3ds )       /* (c) 1985 */
//N DRIVER( crystalg )  /* (c) 1986 */
//N DRIVER( crystal2 )  /* (c) 1986 */
//# DRIVER( nightlov )  /* (c) 1986 */
//N DRIVER( citylove )  /* (c) 1986 */
//- DRIVER( mcitylov )  /* (c) 1986 */
//N DRIVER( apparel )   /* (c) 1986 Central Denshi */
//N DRIVER( secolove )  /* (c) 1986 */
//N DRIVER( barline )   /* (c) 1986?*/
//N DRIVER( housemnq )  /* (c) 1987 */
//N DRIVER( housemn2 )  /* (c) 1987 */
//N DRIVER( livegal )   /* (c) 1987 */
//N DRIVER( seiha )     /* (c) 1987 */
//- DRIVER( seiham )    /* (c) 1987 */
//N DRIVER( mjgaiden )  /* (c) 1987 Central Denshi */
//N DRIVER( bijokkoy )  /* (c) 1987 */
//N DRIVER( iemoto )    /* (c) 1987 */
//- DRIVER( iemotom )   /* (c) 1987 */
//- DRIVER( ryuuha )    /* (c) 1987 */
//N DRIVER( ojousan )   /* (c) 1987 */
//- DRIVER( ojousanm )  /* (c) 1987 */
//N DRIVER( bijokkog )  /* (c) 1988 */
//N DRIVER( orangec )   /* (c) 1988 Daiichi Denshi */
//- DRIVER( orangeci )  /* (c) 1988 Daiichi Denshi */
//- DRIVER( vipclub )   /* (c) 1988 Daiichi Denshi */
//N DRIVER( korinai )   /* (c) 1988 */
//- DRIVER( korinaim )  /* (c) 1988 */
//N DRIVER( kaguya )    /* (c) 1988 MIKI SYOUJI */
//N DRIVER( kaguya2 )   /* (c) 1989 MIKI SYOUJI */
//- DRIVER( kaguya2f )  /* (c) 1989 MIKI SYOUJI */
//N DRIVER( otonano )   /* (c) 1988 Apple */
//N DRIVER( kanatuen )  /* (c) 1988 Panac */
//- DRIVER( kyuhito )   /* (c) 1988 ROLLER TRON */
//N DRIVER( mjsikaku )  /* (c) 1988 */
//- DRIVER( mjsikakb )  /* (c) 1988 */
//- DRIVER( mjsikakc )  /* (c) 1988 */
//- DRIVER( mjsikakd )  /* (c) 1988 */
//- DRIVER( mmsikaku )  /* (c) 1988 */
//N DRIVER( mjcamera )  /* (c) 1988 MIKI SYOUJI */
//- DRIVER( mmcamera )  /* (c) 1988 MIKI SYOUJI */
//N DRIVER( msjiken )   /* (c) 1988 */
//N DRIVER( hanamomo )  /* (c) 1988 */
//- DRIVER( hanamomb )  /* (c) 1988 */
//N DRIVER( telmahjn )  /* (c) 1988 */
//N DRIVER( taiwanmb )  /* (c) 1988 */
//N DRIVER( gionbana )  /* (c) 1989 */
//N DRIVER( idhimitu )  /* (c) 1989 Digital Soft */
//N DRIVER( mgion )     /* (c) 1989 */
//N DRIVER( mjcamerb )  /* (c) 1989 MIKI SYOUJI */
//N DRIVER( omotesnd )  /* (c) 1989 */
//N DRIVER( abunai )    /* (c) 1989 */
//N DRIVER( mjfocus )   /* (c) 1989 */
//- DRIVER( mjfocusm )  /* (c) 1989 */
//- DRIVER( peepshow )  /* (c) 1989 AC */
//N DRIVER( scandal )   /* (c) 1989 */
//- DRIVER( scandalm )  /* (c) 1989 */
//N DRIVER( mgmen89 )   /* (c) 1989 */
//N DRIVER( mjnanpas )  /* (c) 1989 BROOKS */
//- DRIVER( mjnanpaa )  /* (c) 1989 BROOKS */
//- DRIVER( mjnanpau )  /* (c) 1989 BROOKS */
//N DRIVER( pairsnb )   /* (c) 1989 */
//- DRIVER( pairsten )  /* (c) 1989 System Ten */
//N DRIVER( bananadr )  /* (c) 1989 DIGITAL SOFT */
//N DRIVER( mladyhtr )  /* (c) 1990 */
//N DRIVER( chinmoku )  /* (c) 1990 */
//N DRIVER( maiko )     /* (c) 1990 */
//N DRIVER( mmaiko )    /* (c) 1990 */
//# DRIVER( hnageman )  /* (c) 1990 Nichibutsu/AV Japan */
//# DRIVER( hnxmasev )  /* (c) 1990 Nichibutsu/AV Japan */
//N DRIVER( club90s )   /* (c) 1990 */
//- DRIVER( club90sa )  /* (c) 1990 */
//- DRIVER( lovehous )  /* (c) 1990 */
//N DRIVER( hanaoji )   /* (c) 1991 */
//N DRIVER( pstadium )  /* (c) 1990 */
//N DRIVER( triplew1 )  /* (c) 1989 */
//N DRIVER( triplew2 )  /* (c) 1990 */
//N DRIVER( ntopstar )  /* (c) 1990 */
//N DRIVER( mjlstory )  /* (c) 1991 */
//N DRIVER( vanilla )   /* (c) 1991 */
//- DRIVER( finalbny )  /* (c) 1991 */
//N DRIVER( qmhayaku )  /* (c) 1991 */
//N DRIVER( mjgottub )  /* (c) 1991 */
//N DRIVER( galkoku )   /* (c) 1989 Nichibutsu/T.R.TEC */
//- DRIVER( hyouban )   /* (c) 1989 Nichibutsu/T.R.TEC */
//N DRIVER( galkaika )  /* (c) 1989 Nichibutsu/T.R.TEC */
//N DRIVER( tokyogal )  /* (c) 1989 */
//- DRIVER( tokimbsj )  /* (c) 1989 */
//N DRIVER( mcontest )  /* (c) 1989 */
//N DRIVER( uchuuai )   /* (c) 1989 */
//# DRIVER( av2mj1bb )  /* (c) 1991 MIKI SYOUJI/AV JAPAN */
//# DRIVER( av2mj2rg )  /* (c) 1991 MIKI SYOUJI/AV JAPAN */
//N DRIVER( mjuraden )  /* (c) 1992 Nichibutsu/Yubis */
//N DRIVER( koinomp )   /* (c) 1992 */
//N DRIVER( patimono )  /* (c) 1992 */
//N DRIVER( janbari )   /* (c) 1992 Nichibutsu/Yubis/AV JAPAN */
//- DRIVER( mjanbari )  /* (c) 1992 Nichibutsu/Yubis/AV JAPAN */
//N DRIVER( ultramhm )  /* (c) 1993 Apple */
//N DRIVER( gal10ren )  /* (c) 1993 FUJIC */
//N DRIVER( renaiclb )  /* (c) 1993 FUJIC */
//N DRIVER( mjlaman )   /* (c) 1993 Nichibutsu/AV JAPAN */
//N DRIVER( mkeibaou )  /* (c) 1993 */
//N DRIVER( pachiten )  /* (c) 1993 Nichibutsu/MIKI SYOUJI/AV JAPAN */
//N DRIVER( sailorws )  /* (c) 1993 */
//- DRIVER( sailorwa )  /* (c) 1993 */
//- DRIVER( sailorwr )  /* (c) 1993 */
//N DRIVER( wcatcher )  /* (c) 1993 */
//N DRIVER( jituroku )  /* (c) 1993 Windom */
//N DRIVER( yosimoto )  /* (c) 1994 Nichibutsu/Yoshimoto Kougyou */
//N DRIVER( psailor1 )  /* (c) 1994 SPHINX */
//N DRIVER( psailor2 )  /* (c) 1994 SPHINX */
//N DRIVER( otatidai )  /* (c) 1995 SPHINX */
//N DRIVER( ngpgal )    /* (c) 1991 */
//N DRIVER( mjgottsu )  /* (c) 1991 */
//- DRIVER( bakuhatu )  /* (c) 1991 */
//N DRIVER( cmehyou )   /* (c) 1992 Nichibutsu/Kawakusu */
//N DRIVER( mmehyou )   /* (c) 1992 Nichibutsu/Kawakusu */
//N DRIVER( mjkoiura )  /* (c) 1992 */
//- DRIVER( mkoiuraa )  /* (c) 1992 */
//N DRIVER( imekura )   /* (c) 1994 SPHINX/AV JAPAN */
//N DRIVER( mscoutm )   /* (c) 1994 SPHINX/AV JAPAN */
//N DRIVER( mjegolf )   /* (c) 1994 FUJIC/AV JAPAN */
//N DRIVER( mhhonban )  /* (c) 199? */
//N DRIVER( 4psimasy )  /* (c) 1994 */
//N DRIVER( musobana )  /* (c) 1995 */
//N DRIVER( niyanpai )  /* (c) 1996 */
#endif

    /* "Phoenix hardware" (and variations) games */
#ifdef __GAME__PHOENIX__
...
//N DRIVER( trvmstr )   /* (c) 1985 Enerdyne Technologies Inc. */
...
//N DRIVER( pistoldm )  /* (c) 1990 (Japan) */
    DRIVER( boxyboy )   /* (c) 1990 (US) */
//- DRIVER( soukobdx )  /* (c) 1990 (Japan) */
//N DRIVER( puzlclub )  /* (c) 1990 (Japan) */
...
//N DRIVER( metlhawk )  /* (c) 1988 */
//- DRIVER( metlhawkj ) /* (c) 1988 */
    DRIVER( ordyne )    /* (c) 1988 */
//- DRIVER( ordynej )   /* (c) 1988 */
//N DRIVER( mirninja )  /* (c) 1988 (Japan) */
    DRIVER( phelios )   /* (c) 1988 (Japan) */
//N DRIVER( dirtfoxj )  /* (c) 1989 (Japan) */
    DRIVER( fourtrax )  /* 89.11 */
//N DRIVER( valkyrie )  /* (c) 1989 (Japan) */
...
//N DRIVER( kyukaidk )  /* (c) 1990 (Japan) */
...
//N DRIVER( bubbletr )  /* (c) 1992 */
//N DRIVER( finalap3 )  /* 92.9  Final Lap 3 */
//- DRIVER( finalap3j ) /* 92.9  Final Lap 3 */
    DRIVER( luckywld )  /* (c) 1992 */
//- DRIVER( luckywldj ) /* (c) 1992 */
//N DRIVER( suzuka8h )  /* (c) 1992 (World) */
//- DRIVER( suzuka8hj ) /* (c) 1992 (Japan) */
//N DRIVER( sws )       /* (c) 1992 (Japan) */
//N DRIVER( sws92 )     /* (c) 1992 (Japan) */
//- DRIVER( sws92g )    /* (c) 1992 (Japan) */
//N DRIVER( suzuk8h2 )  /* (c) 1993 (World) */
//N DRIVER( sws93 )     /* (c) 1993 (Japan) */
    /* Namco FL games */
//N DRIVER( speedrcr )  /* (c) 1995 */
//N DRIVER( finalapr )  /* (c) 1995 */
//- DRIVER( finalaprb ) /* (c) 1995 */
//- DRIVER( finalapro ) /* (c) 1995 */
    /* Namco NA-1 / NA-2 System games */
//N DRIVER( bkrtmaq )   /* (c) 1992 (Japan) */
...
//N DRIVER( quiztou )   /* (c) 1993 (Japan) */
//N DRIVER( tinklpit )  /* (c) 1993 (Japan) */
//N DRIVER( xday2 )     /* (c) 1995 (Japan) */
...
//N DRIVER( gslugrsj )  /* (c) 1993 (Japan) */
//N DRIVER( gslgr94u )  /* (c) 1994 */
//- DRIVER( gslgr94j )  /* (c) 1994 (Japan) */
//N DRIVER( sws95 )     /* (c) 1995 (Japan) */
//N DRIVER( sws96 )     /* (c) 1996 (Japan) */
//N DRIVER( sws97 )     /* (c) 1997 (Japan) */
//N DRIVER( vshoot )    /* (c) 1994 */
    DRIVER( outfxies )  /* (c) 1994 (World) */
//- DRIVER( outfxiesj ) /* (c) 1994 (Japan) */
//N DRIVER( machbrkr )  /* (c) 1995 (Japan) */
    /* Namco ND-1 games */
    DRIVER( ncv1 )      /* (c) 1995 */
...
//N DRIVER( 8ballact )  /* (c) 1984 Seatongrove Ltd (Magic Eletronics USA licence) */
//- DRIVER( 8ballact2 ) /* (c) 1984 Seatongrove Ltd (Magic Eletronics USA licence) */
//N DRIVER( shootgal )  /* (c) 1984 Seatongrove Ltd (Zaccaria licence) */
    DRIVER( drakton )   /* (c) 1984 Epos Corporation */
//- DRIVER( drktnjr )   /* (c) 1984 Epos Corporation */
    DRIVER( strtheat )  /* (c) 1985 Epos Corporation */
//N DRIVER( hunchbkd )  /* (c) 1983 Century */
//N DRIVER( sbdk )      /* (c) 1984 Century */
    DRIVER( herbiedk )  /* (c) 1984 CVS */
    DRIVER( herodk )    /* (c) 1984 Seatongrove + Crown license */
//N DRIVER( herodku )   /* (c) 1984 Seatongrove + Crown license */
    DRIVER( skyskipr )  /* (c) 1981 */
    DRIVER( popeye )    /* (c) 1982 */
//- DRIVER( popeyeu )   /* (c) 1982 */
//- DRIVER( popeyef )   /* (c) 1982 */
//- DRIVER( popeyebl )  /* bootleg */
//N DRIVER( punchout )  /* (c) 1984 */
//- DRIVER( punchita )  /* bootleg */
//N DRIVER( spnchout )  /* (c) 1984 */
//- DRIVER( spnchoutj ) /* (c) 1984 (Japan) */
//N DRIVER( armwrest )  /* (c) 1985 */
    /* Nintendo Playchoice 10 games */
//U DRIVER( playch10 )  /* BIOS */
//N DRIVER( pc_tenis )  /* (c) 1983 Nintendo */
//N DRIVER( pc_mario )  /* (c) 1983 Nintendo */
//N DRIVER( pc_bball )  /* (c) 1984 Nintendo of America */
//N DRIVER( pc_bfght )  /* (c) 1984 Nintendo */
//N DRIVER( pc_ebike )  /* (c) 1984 Nintendo */
//N DRIVER( pc_golf )   /* (c) 1984 Nintendo */
//N DRIVER( pc_kngfu )  /* (c) 1984 Irem (Nintendo license) */
//N DRIVER( pc_1942 )   /* (c) 1985 Capcom */
//N DRIVER( pc_smb )    /* (c) 1985 Nintendo */
//N DRIVER( pc_vball )  /* (c) 1986 Nintendo */
//N DRIVER( pc_duckh )  /* (c) 1984 Nintendo */
//N DRIVER( pc_hgaly )  /* (c) 1984 Nintendo */
//N DRIVER( pc_wgnmn )  /* (c) 1984 Nintendo */
//N DRIVER( pc_grdus )  /* (c) 1986 Konami */
//- DRIVER( pc_grdue )  /* (c) 1986 Konami */
//N DRIVER( pc_tkfld )  /* (c) 1987 Konami (Nintendo of America license) */
//N DRIVER( pc_pwrst )  /* (c) 1986 Nintendo */
//N DRIVER( pc_trjan )  /* (c) 1986 Capcom USA (Nintendo of America license) */
//N DRIVER( pc_cvnia )  /* (c) 1987 Konami (Nintendo of America license) */
//N DRIVER( pc_dbldr )  /* (c) 1987 Konami (Nintendo of America license) */
//N DRIVER( pc_rnatk )  /* (c) 1987 Konami (Nintendo of America license) */
//N DRIVER( pc_rygar )  /* (c) 1987 Tecmo (Nintendo of America license) */
//N DRIVER( pc_cntra )  /* (c) 1988 Konami (Nintendo of America license) */
//N DRIVER( pc_goons )  /* (c) 1986 Konami */
//N DRIVER( pc_mtoid )  /* (c) 1986 Nintendo */
//N DRIVER( pc_radrc )  /* (c) 1987 Square */
//N DRIVER( pc_miket )  /* (c) 1987 Nintendo */
//N DRIVER( pc_rcpam )  /* (c) 1987 Rare */
//N DRIVER( pc_ngaid )  /* (c) 1989 Tecmo (Nintendo of America license) */
//N DRIVER( pc_tmnt )   /* (c) 1989 Konami (Nintendo of America license) */
//N DRIVER( pc_ftqst )  /* (c) 1989 Sunsoft (Nintendo of America license) */
//N DRIVER( pc_bstar )  /* (c) 1989 SNK (Nintendo of America license) */
//N DRIVER( pc_tbowl )  /* (c) 1989 Tecmo (Nintendo of America license) */
//N DRIVER( pc_drmro )  /* (c) 1990 Nintendo */
//N DRIVER( pc_ynoid )  /* (c) 1990 Capcom USA (Nintendo of America license) */
//N DRIVER( pc_rrngr )  /* (c) Capcom USA (Nintendo of America license) */
//N DRIVER( pc_ddrgn )  /* (c) 1988 Technos */
//N DRIVER( pc_gntlt )  /* (c) 1985 Atari/Tengen (Nintendo of America license) */
//N DRIVER( pc_smb2 )   /* (c) 1988 Nintendo */
//N DRIVER( pc_smb3 )   /* (c) 1988 Nintendo */
//N DRIVER( pc_mman3 )  /* (c) 1990 Capcom USA (Nintendo of America license) */
//N DRIVER( pc_radr2 )  /* (c) 1990 Square (Nintendo of America license) */
//N DRIVER( pc_suprc )  /* (c) 1990 Konami (Nintendo of America license) */
//N DRIVER( pc_tmnt2 )  /* (c) 1990 Konami (Nintendo of America license) */
//N DRIVER( pc_wcup )   /* (c) 1990 Technos (Nintendo license) */
//N DRIVER( pc_ngai2 )  /* (c) 1990 Tecmo (Nintendo of America license) */
//N DRIVER( pc_ngai3 )  /* (c) 1991 Tecmo (Nintendo of America license) */
//N DRIVER( pc_pwbld )  /* (c) 1991 Taito (Nintendo of America license) */
//N DRIVER( pc_rkats )  /* (c) 1991 Atlus (Nintendo of America license) */
//N DRIVER( pc_pinbt )  /* (c) 1988 Rare (Nintendo of America license) */
//N DRIVER( pc_cshwk )  /* (c) 1989 Rare (Nintendo of America license) */
//N DRIVER( pc_sjetm )  /* (c) 1990 Rare */
//N DRIVER( pc_moglf )  /* (c) 1991 Nintendo */
    /* Nintendo VS games */
...
//N DRIVER( rbibb )     /* (c) 1987 Namco */
//- DRIVER( rbibba )    /* (c) 1987 Namco */
//N DRIVER( suprmrio )  /* (c) 1986 Nintendo */
//- DRIVER( suprmrioa ) /* (c) 1986 Nintendo */
//- DRIVER( skatekds )  /* (c) 1988 (hack) */
//N DRIVER( vsskykid )  /* (c) 1986 Namco */
//N DRIVER( tkoboxng )  /* (c) 1987 Data East */
//N DRIVER( smgolf )    /* (c) 1984 Nintendo */
//- DRIVER( smgolfj )   /* (c) 1984 Nintendo */
//N DRIVER( vspinbal )  /* (c) 1984 Nintendo */
...
//N DRIVER( jajamaru )  /* (c) 1985 Jaleco */
    DRIVER( topgun )    /* (c) 1987 Konami */
    DRIVER( bnglngby )  /* (c) 1985 Nintendo / Broderbund Software Inc. */
//N DRIVER( vstennis )  /* (c) 1984 Nintendo */
//- DRIVER( vstennisj ) /* (c) 1984 Nintendo */
//N DRIVER( wrecking )  /* (c) 1984 Nintendo */
//N DRIVER( balonfgt )  /* (c) 1984 Nintendo */
//N DRIVER( vsmahjng )  /* (c) 1984 Nintendo */
//N DRIVER( vsbball )   /* (c) 1984 Nintendo */
//- DRIVER( vsbballj )  /* (c) 1984 Nintendo */
//- DRIVER( vsbballja ) /* (c) 1984 Nintendo */
//- DRIVER( vsbballjb ) /* (c) 1984 Nintendo */
//N DRIVER( iceclmrj )  /* (c) 1984 Nintendo */
...
#ifdef __GAME__MIDW8080__
    DRIVER( seawolf )   /* 596 [1976] */
    DRIVER( gunfight )  /* 597 [1975] */
                        /* 603 - Top Gun [1976] */
//N DRIVER( tornbase )  /* 605 [1976] */
...
//- DRIVER( darthvdr )  /* bootleg */
    ...
    /* Meadows S2650 games */
#ifdef __GAME__MEADOWS__
    DRIVER( lazercmd )  /* [1976?] */
    DRIVER( bbonk )     /* [1976?] */
    DRIVER( deadeye )   /* [1978?] */
//N DRIVER( bowl3d )    /* [1978?] */
//N DRIVER( gypsyjug )  /* [1978?] */
//N DRIVER( minferno )  /* [1978?] */
//N DRIVER( medlanes )  /* [1977?] */
#endif

    /* CVS games */
#ifdef __GAME__CVS__
    DRIVER( cosmos )    /* (c) 1981 Century */
//N DRIVER( darkwar )   /* (c) 1981 Century */
...
//N DRIVER( sarge )     /* (c) 1985 */
    DRIVER( rampage )   /* (c) 1986 */
//- DRIVER( rampage2 )  /* (c) 1986 */
//N DRIVER( powerdrv )  /* (c) 1986 */
    DRIVER( stargrds )  /* (c) 1987 */
//N DRIVER( maxrpm )    /* (c) 1986 */
    DRIVER( spyhunt )   /* (c) 1983 */
//- DRIVER( spyhuntp )  /* (c) 1983 */
    DRIVER( turbotag )  /* (c) 1985 */
    DRIVER( crater )    /* (c) 1984 */
    /* MCR 68000 */
//N DRIVER( zwackery )  /* (c) 1984 */
//N DRIVER( xenophob )  /* (c) 1987 */
//N DRIVER( spyhunt2 )  /* (c) 1987 */
//- DRIVER( spyhunt2a ) /* (c) 1987 */
//N DRIVER( blasted )   /* (c) 1988 */
//N DRIVER( archrivl )  /* (c) 1989 */
//- DRIVER( archrivl2 ) /* (c) 1989 */
//N DRIVER( trisport )  /* (c) 1989 */
...
//N DRIVER( triviag1 )  /* (c) 1984 */
//N DRIVER( trivia12 )  /* (c) 1984 */
//N DRIVER( triviag2 )  /* (c) 1984 */
//N DRIVER( triviasp )  /* (c) 1984 */
//N DRIVER( triviayp )  /* (c) 1984 */
//N DRIVER( triviabb )  /* (c) 1984 */
//N DRIVER( triviaes )  /* (c) 1984 */
//N DRIVER( gimeabrk )  /* (c) 1985 */
    DRIVER( minigolf )  /* (c) 1985 */
//- DRIVER( minigolf2 ) /* (c) 1985 */
    DRIVER( toggle )    /* (c) 1985 */
//N DRIVER( nametune )  /* (c) 1986 */
...
//N DRIVER( ptrmj )     /* M14 (c) 1979  */
//S DRIVER( skychut )   /* Irem [1980] */
//S DRIVER( spacbeam )  /* M15 no copyright notice */
//# DRIVER( greenber )  /* Irem */
//S DRIVER( headoni )   /* Irem no copyright notice (1979 - Arcade TV Game List - P.98, Left, 7 from top ) */
//S DRIVER( panther )   /* M27 no copyright notice */
    DRIVER( redalert )  /* M27 (c) 1981 + "GDI presents" */
//# DRIVER( demoneye )  /* M27 (c) 1981 */
//N DRIVER( ww3 )       /* M27 (c) 1981 */
...
//N DRIVER( fghtbskt )  /* (c) 1984 Paradise Co. Ltd. */
    /* M62 */
...
//N DRIVER( lotlot )    /* (c) 1985 licensed from Tokuma Shoten */
...
//N DRIVER( spelunk2 )  /* (c) 1986 licensed from Broderbund */
    DRIVER( horizon )   /* (c) 1985 */
//N DRIVER( youjyudn )  /* (c) 1986 (Japan) */
    DRIVER( vigilant )  /* (c) 1988 (World) */
//- DRIVER( vigilantu ) /* (c) 1988 (US) */
//- DRIVER( vigilantj ) /* (c) 1988 (Japan) */
//N DRIVER( kikcubic )  /* (c) 1988 (Japan) */
...
//N DRIVER( poundfor )  /* (c) 1990 (World) */
...
//N DRIVER( matchit )   /* (c) 1989 Tamtex */   
    /* M90 */
//N DRIVER( hasamu )    /* (c) 1991 Irem (Japan) */
...
//N DRIVER( quizf1 )    /* (c) 1992 Irem (Japan) */
...
//N DRIVER( majtitl2 )  /* (c) 1992 Irem (World) */
...
//N DRIVER( nbbatman )  /* (c) 1993 Irem America (US) */
...
//- DRIVER( geostorm )  /* (c) 1994 Irem (Japan) */
    /* M107 */
//S DRIVER( firebarr )  /* (c) 1993 Irem (Japan) */
...
//S DRIVER( tylz )      /* GV-??? (c) 1982 Gottlieb - never released */
    DRIVER( argusg )    /* GV-??? (c) 1982 Gottlieb - never released */
    DRIVER( krull )     /* GV-105 (c) 1983 Gottlieb */
//S DRIVER( kngtmare )  /* GV-??? (c) 1983 Gottlieb - never released */
    DRIVER( sqbert )    /* GV-??? (c) 1983 Mylstar - never released */
//N DRIVER( mach3 )     /* GV-109 (c) 1983 Mylstar */
//N DRIVER( cobram3 )   /* ...... (c) 1984 Data East */
//N DRIVER( usvsthem )  /* GV-??? (c) 198? Mylstar */
    DRIVER( 3stooges )  /* GV-113 (c) 1984 Mylstar */
    DRIVER( qbertqub )  /* GV-119 (c) 1983 Mylstar */
//N DRIVER( screwloo )  /* GV-123 (c) 1983 Mylstar - never released */
//N DRIVER( curvebal )  /* GV-134 (c) 1984 Mylstar */
//N DRIVER( vidvince )  /* GV-??? (c) 1984 Mylstar - never released  */
//N DRIVER( wizwarz )   /* GV-??? (c) 1984 Mylstar - never released */
    DRIVER( exterm )    /* (c) 1989 Premier Technology - a Gottlieb game */
#endif

    /* Taito "Qix hardware" games */
#ifdef __GAME__TAITO_SEIBU__
...
//- DRIVER( tinstar2 )  /* A10 (c) 1983 Taito Corporation */
    ...
    /* other Taito games */
//N DRIVER( fgoal )     /* TF  (c) 1979 Taito Corporation */
...
//N DRIVER( sbowling )  /* KB  (c) 1982 Taito Corporation */
//S DRIVER( grchamp )   /* GM  (c) 1981 Taito Corporation */
//S DRIVER( marinedt )  /* MG  (c) 1981 Taito Corporation */
    DRIVER( changela )  /* ??? (c) 1983 Taito Corporation */
    DRIVER( jollyjgr )  /* KD  (c) 1982 Taito Corporation */
//N DRIVER( bking )     /* DM  (c) 1982 Taito Corporation */
//N DRIVER( bking2 )    /* AD6 (c) 1983 Taito Corporation */
//N DRIVER( bking3 )    /* A24 (c) 1984 Taito Corporation */
//N DRIVER( chaknpop )  /* A04 (c) 1983 Taito Corporation */
...
//N DRIVER( buggychl )  /* A22 (c) 1984 Taito Corporation */
//- DRIVER( buggychlt ) /* A22 (c) 1984 Taito Corporation + Tefri license */
//N DRIVER( ssrj )      /* A40 (c) 1985 Taito Corporation */
//N DRIVER( bigevglf )  /* A67 (c) 1986 Taito America Corporation (US) */
...
//N DRIVER( onna34ro )  /* A52 (c) 1985 Taito Corporation (Japan) */
//- DRIVER( onna34roa ) /* A52 (c) 1985 Taito Corporation (Japan) */
//N DRIVER( victnine )  /* A16 (c) 1985 Taito Corporation (Japan) */
...
//- DRIVER( colt )      /* bootleg */
//N DRIVER( ksayakyu )  /* ??? (c) 1985 Taito Corporation */
    DRIVER( benberob )  /* A26 */
...
//N DRIVER( daikaiju )  /* A74 (c) 1986 Taito */
...
//N DRIVER( missb2 )    /* bootleg on enhanced hardware */
//N DRIVER( kikikai )   /* A85 (c) 1986 Taito Corporation */
...
//N DRIVER( darius )    /* A96 (c) 1986 Taito Corporation Japan (World) */
...
//N DRIVER( perestro )  /* (c) 1994 Promat */
//- DRIVER( perestrof ) /* (c) 1993 Promat / Fuuki */
//N DRIVER( pbillian )  /* (c) 1986 Taito */
//N DRIVER( hotsmash )  /* B18 (c) 1987 Taito */
    DRIVER( exzisus )   /* B12 (c) 1987 Taito Corporation (Japan) */
//- DRIVER( exzisusa )  /* B23 (c) 1987 Taito Corporation (Japan) */
//N DRIVER( minivadr )  /* D26 cabinet test board */
...
//N DRIVER( eto )       /* (c) 1994 Visco (Japan) */
...
//N DRIVER( darius2 )   /* C07 (c) 1989 Taito Corporation (Japan) */
//- DRIVER( darius2d )  /* C07 (c) 1989 Taito Corporation (Japan) */
//- DRIVER( darius2do ) /* C07 (c) 1989 Taito Corporation (Japan) */
//N DRIVER( warriorb )  /* D24 (c) 1991 Taito Corporation (Japan) */
...
//N DRIVER( chukatai )  /* B44 (c) 1988 Taito Corporation Japan (World) */
...
//N DRIVER( champbwl )  /* (c)1989 Romstar.  not Taito, but the same Seta video chips */
...
//N DRIVER( kurikint )  /* B42 (c) 1988 Taito Corporation Japan (World) */
...
//N DRIVER( palamed )   /* C63 (c) 1990 Taito Corporation (Japan) */
//N DRIVER( cachat )    /* ??? (c) 1993 Taito Corporation (Japan) */
//- DRIVER( tubeit )    /* ??? no copyright message */
    DRIVER( cubybop )   /* ??? no copyright message */
//N DRIVER( plgirls )   /* (c) 1992 Hot-B. */
//N DRIVER( plgirls2 )  /* (c) 1993 Hot-B. */
    /* Taito H-System games */
//N DRIVER( syvalion )  /* B51 (c) 1988 Taito Corporation (Japan) */
    DRIVER( recordbr )  /* B56 (c) 1988 Taito Corporation Japan (World) */
//- DRIVER( gogold )    /* B56 (c) 1988 Taito Corporation (Japan) */
//N DRIVER( dleague )   /* C02 (c) 1990 Taito Corporation (Japan) */
    /* Taito B-System games */
//N DRIVER( masterw )   /* B72 (c) 1989 Taito Corporation Japan (World) */
...
//N DRIVER( hitice )    /* C59 (c) 1990 Williams (US) */
//- DRIVER( hiticej )   /* C59 (c) 1990 Midway/Taito Corporation (Japan) */
//N DRIVER( sbm )       /* C69 (c) 1990 Taito Corporation (Japan) */
...
//N DRIVER( qzshowby )  /* D72 (c) 1993 Taito Corporation (Japan) */
//N DRIVER( pbobble )   /* ??? (c) 1994 Taito Corporation (Japan) */
...
//N DRIVER( gunbustr )  /* D27 (c) 1992 Taito Corporation (Japan) */
    DRIVER( superchs )  /* D46 (c) 1992 Taito America Corporation (US) */
//N DRIVER( groundfx )  /* D51 (c) 1992 Taito Coporation */
...
//N DRIVER( qtorimon )  /* 1990.02 C41 (c) 1990 Taito Corporation (Japan) */
...
//N DRIVER( quizhq )    /* 1990.07 C53 (c) 1990 Taito Corporation (Japan) */
...
//N DRIVER( mjnquest )  /* 1991.05 C77 (c) 1990 Taito Corporation (Japan) */
...
//N DRIVER( koshien )   /* 1991.04 C81 (c) 1990 Taito Corporation (Japan) */
//N DRIVER( yuyugogo )  /* 1991.03 C83 (c) 1990 Taito Corporation (Japan) */
...
//N DRIVER( qzquest )   /* 1991.07 C92 (c) 1991 Taito Corporation (Japan) */
...
//N DRIVER( qzchikyu )  /* 1992.02 D19 (c) 1991 Taito Corporation (Japan) */
//N DRIVER( yesnoj )    /* 1992.03 D20 (c) 1992 Taito Corporation (Japan) */
...
//N DRIVER( qjinsei )   /* 1993.03 D48 (c) 1992 Taito Corporation (Japan) */
//N DRIVER( qcrayon )   /* 1993.08 D55 (c) 1993 Taito Corporation (Japan) */
//N DRIVER( qcrayon2 )  /* 1994.01 D63 (c) 1993 Taito Corporation (Japan) */
    DRIVER( driftout )  /* 1991.10 (c) 1991 Visco */
//- DRIVER( driveout )  /* bootleg */
    /* Taito F3 games */
//N DRIVER( ringrage )  /* 1992.?? D21 (c) 1992 Taito Corporation Japan (World) */
...
//S DRIVER( ridingf )   /* 1992.?? D34 (c) 1992 Taito Corporation Japan (World) */
...
//N DRIVER( qtheater )  /* 1995.01 D95 (c) 1994 Taito Corporation (Japan) */
...
//N DRIVER( quizhuhu )  /* 1995.07 E08 (c) 1995 Taito Corporation (Japan) */
...
//N DRIVER( bubblem )   /* 1996.?? E21 (c) 1995 Taito Corporation Japan (World) */
//- DRIVER( bubblemj )  /* 1996.04 E21 (c) 1995 Taito Corporation (Japan) */
//N DRIVER( cleopatr )  /* 1996.10 E28 (c) 1996 Taito Corporation (Japan) */
...
//N DRIVER( kirameki )  /* 1997.09 E44 (c) 1997 Taito Corporation (Japan) */
...
//N DRIVER( landmakr )  /* 1998.08 E61 (c) 1998 Taito Corporation (Japan) */
//- DRIVER( landmakrp ) /* 1998.?? E61 (c) 1998 Taito Corporation (World, prototype) */
//N DRIVER( recalh )    /* prototype */
//N DRIVER( commandw )  /* prototype */
    /* Taito JC System */
...
//# DRIVER( landgear )  /* 1996.?? E17 (c) 1995 Taito Corporation Japan (World) */
                        /* 1996.03 (Japan) */
//N DRIVER( sidebs )    /* 1996.07 E23 (c) 1996 Taito Corporation (Japan) */
//# DRIVER( dendeg )    /* 1997.03 E35 (c) 1996 Taito Corporation (Japan) */
//- DRIVER( sidebs2j )  /* 1997.07 E38 (c) 1997 Taito Corporation (Japan) */
//N DRIVER( sidebs2 )   /* 1997.?? E38 (c) 1997 Taito Corporation (Japan) */
...
//# DRIVER( landhigh )  /* E68 (c) 1999 Taito */
    ...
    /* Toaplan games */
#ifdef __GAME__TOAPLAN__
//N DRIVER( perfrman )  /* (c) 1985 Data East Corporation (Japan) */
...
//N DRIVER( slapbtjp )  /* bootleg but (c) 1986 Taito Corporation */
//N DRIVER( slapbtuk )  /* bootleg but (c) 1986 Taito Corporation */
...
//N DRIVER( mjsister )  /* (c) 1986 Toaplan */
...
//N DRIVER( fireshrk )  /* TP-O17 (c) 1990 Toaplan */
...
//N DRIVER( vimana )    /* TP-O19 (c) 1991 Toaplan (+ Tecmo license when set to Japan) */
...
//N DRIVER( honeydol )  /* (c) 1995 Barko Corp */
...
//N DRIVER( moremorp )  /* (c) 1999 SemiCom + Exit */
...
//- DRIVER( snowbros3 ) /* (c) 2002 but hack / bootleg of snowbros? */
    ...
    /* More Toaplan Games */
//N DRIVER( tekipaki )  /* TP-020 (c) 1991 Toaplan */
//N DRIVER( ghox )      /* TP-021 (c) 1991 Toaplan */
//- DRIVER( ghoxj )     /* TP-021 (c) 1991 Toaplan */
//N DRIVER( dogyuun )   /* TP-022 (c) 1992 Toaplan */
...
//N DRIVER( mahoudai )  /* (c) 1993 Raizing + Able license */
//N DRIVER( shippumd )  /* (c) 1994 Raizing/8ing */
...
//N DRIVER( feversos )  /* (c) 1998 Cave + Nihon System license */
    DRIVER( esprade )   /* (c) 1998 Atlus/Cave */
//- DRIVER( espradej )  /* (c) 1998 Atlus/Cave (Japan) */
//- DRIVER( espradejo ) /* (c) 1998 Atlus/Cave (Japan) */
//N DRIVER( uopoko )    /* (c) 1998 Cave + Jaleco license */
//- DRIVER( uopokoj )   /* (c) 1998 Cave + Jaleco license */
//N DRIVER( guwange )   /* (c) 1999 Atlus/Cave */
//N DRIVER( gaia )      /* (c) 1999 Noise Factory */
//N DRIVER( theroes )   /* (c) 2001 Primetek Investments */
//N DRIVER( korokoro )  /* (c) 1999 Takumi */
#endif
...
//N DRIVER( lottofun )  /* (c) 1987 H.A.R. Management */
#endif
...
//N DRIVER( 1943kai )   /*  6/1988 (c) 1987 (Japan) */
...
//N DRIVER( cworld2j )  /* 11/06/1992 (QUIZ 5) (c) 1992 (Japan) */
...
//N DRIVER( slammast )  /* 13/07/1993 (c) 1993 (World) (CPS1 + QSound) */
//- DRIVER( slammastu ) /* 13/07/1993 (c) 1993 (US)    (CPS1 + QSound) */
//- DRIVER( mbomberj )  /* 13/07/1993 (c) 1993 (Japan) (CPS1 + QSound) */
//N DRIVER( mbombrd )   /* 06/12/1993 (c) 1993 (World) (CPS1 + QSound) */
//- DRIVER( mbombrdj )  /* 06/12/1993 (c) 1993 (Japan) (CPS1 + QSound) */
//N DRIVER( pnickj )    /* 08/06/1994 (c) 1994 Compile + Capcom license (Japan) not listed on Capcom's site */
//N DRIVER( qad )       /* 01/07/1992 (c) 1992 (US)    */
//- DRIVER( qadj )      /* 21/09/1994 (c) 1994 (Japan) */
//N DRIVER( qtono2 )    /* 23/01/1995 (c) 1995 (Japan) */
...
//N DRIVER( qndream )   /* 26/06/1996 (c) 1996 (Japan) */
...
//N DRIVER( jyangoku )  /* 27/05/1999 (c) 1999 (Japan) */
...
//N DRIVER( pzloop2 )   /* 02/03/2001 (c) 2001 Mitchell (Euro) */
//- DRIVER( pzloop2j )  /* 05/02/2001 (c) 2001 Mitchell (Japan) */
//N DRIVER( choko )     /* 20/08/2001 (c) 2001 Mitchell (Japan) */
...
//- DRIVER( mmatrixd )
    /* Capcom CPS3 games */
//N DRIVER( sfiii )     /* 04/02/1997 (c) 1997 Capcom */
//- DRIVER( sfiiij )    /* 04/02/1997 (c) 1997 Capcom */
//N DRIVER( sfiii2 )    /* 30/09/1997 (c) 1997 Capcom */
//- DRIVER( sfiii2j )   /* 30/09/1997 (c) 1997 Capcom */
//N DRIVER( sfiii3 )    /* 08/06/1999 (c) 1999 Capcom */
//- DRIVER( sfiii3a )   /* 12/05/1999 (c) 1999 Capcom */
//N DRIVER( jojo )      /* 08/01/1999 (c) 1998 Capcom */
//- DRIVER( jojoa )     /* 02/12/1998 (c) 1998 Capcom */
//N DRIVER( jojoba )    /* 13/09/1999 (c) 1999 Capcom */
//N DRIVER( redearth )  /* 21/11/1996 (c) 1996 Capcom */
...
//N DRIVER( glpracr )   /* Gallop Racer (JAPAN Ver 9.01.12) */
...
//N DRIVER( doapp )     /* Dead Or Alive ++ (JAPAN) */
    DRIVER( cbaj )      /* Cool Boaders Arcade Jam */
//N DRIVER( shngmtkb )  /* Shanghai Matekibuyuu */
//N DRIVER( tondemo )   /* Tondemo Crisis (JAPAN) */
//N DRIVER( glpracr3 )  /* Gallop Racer 3 (JAPAN) */
    DRIVER( flamegun )  /* Flame Gunner (USA) */
//- DRIVER( flamegunj ) /* Flame Gunner (JAPAN) */
//N DRIVER( tblkkuzu )  /* The Block Kuzushi (JAPAN) */
...
//N DRIVER( jdredd )    /* Judge Dredd (Rev C) */
...
//N DRIVER( mgcldtex )  /* Magical Date EX (JAPAN Ver 2.01J) */
    /* Taito FX1b */
...
//N DRIVER( gdarius2 )  /* G-Darius Ver.2 (Ver 2.03J) */
    /* Taito GNET */
//N DRIVER( taitogn )   /* BIOS */
//N DRIVER( chaoshea )  /* 1998.10 Chaos Heat (V2.09O) */
//- DRIVER( chaosheaj ) /* 1998.10 Chaos Heat (V2.08J) */
//N DRIVER( raycris )   /* 1998.12 Ray Crisis (V2.03J) */
//N DRIVER( otenamih )  /* 1999.02 Otenami Haiken (Success) */
//N DRIVER( otenamhf )  /* 2005.04 Otenami Haiken Final (V2.07JC) */
//- DRIVER( spuzboblj ) /* 1999.03 Super Puzzle Bobble (Japan) */
//N DRIVER( spuzbobl )  /* 1999.?? Super Puzzle Bobble (V2.05O) */
//# DRIVER( gobyrc )    /* 1999.?? Go By RC (V2.03O) */
//# DRIVER( rcdego )    /* 1999.06 RC De Go (V2.03J) */
//N DRIVER( flipmaze )  /* 1999.09 Flip Maze (V2.04J) */
//N DRIVER( mahjngoh )  /* 1999.12 Mahjong Oh (V2.06J) */
//N DRIVER( psyvaria )  /* 2000.03 Psyvariar -Medium Unit- (V2.04J) */
//N DRIVER( shanghss )  /* 2000.07 Shanghai Shoryu Sairin (V2.03J) */
//N DRIVER( psyvarrv )  /* 2000.09 Psyvariar -Revision- (V2.04J) */
//N DRIVER( zokuoten )  /* 2000.12 Zoku Otenamihaiken (V2.03J) */
                        /* 2000.?? Taito Classic (Success, not released?) */
//N DRIVER( soutenry )  /* 2001.02 Soutenryu (V2.07J) */
//# DRIVER( nightrai )  /* 2001.05 Night Raid (V2.03J) */
//N DRIVER( shikigam )  /* 2001.09 Shikigami no Shiro */
//N DRIVER( otenki )    /* 2001.10 Otenki Kororin */
//N DRIVER( usagi )     /* 2001.12 Usagi (V2.02J) */
//N DRIVER( shangtou )  /* 2002.02 Shanghai Sangokuhaitougi */
//N DRIVER( xiistag )   /* 2002.07 XII Stag (V2.01J) */
//# DRIVER( sianniv )   /* 2003.10 Space Invaders Anniversary (V2.02J) */
//N DRIVER( kollon )    /* 2003.11 Kollon (V2.04J) */
...
//N DRIVER( primglex )  /* 1996.03 Prime Goal EX (PG1/VER.A, Japan) */
...
//N DRIVER( danceyes )  /* 1996.09 Dancing Eyes (DC1/VER.A, Japan) */
//N DRIVER( pocketrc )  /* 1997.03 Pocket Racer (PKR1/VER.B, Japan) */
//N DRIVER( starswep )  /* 1997.07 Star Sweep (STP1/VER.A, Japan) */
//N DRIVER( myangel3 )  /* 1998.03 Kosodate Quiz My Angel 3 (KQT1/VER.A, Japan) */
...
//N DRIVER( toukon3 )   /* 1997.12 Shin Nihon Pro Wrestling Toukon Retsuden 3 Arcade Edition (TR1/VER.A, Japan) */
    DRIVER( ehrgeiz )   /* 1998.?? Ehrgeiz (EG3/VER.A) */
//- DRIVER( ehrgeiza )  /* 1998.?? Ehrgeiz (EG2/VER.A) */
//- DRIVER( ehrgeizj )  /* 1998.05 Ehrgeiz (EG1, Japan) */
//N DRIVER( sws98 )     /* 1998.06 Super World Stadium '98 (SS81/VER.A, Japan) */
...
//N DRIVER( pacapp )    /* 1998.12 Paca Paca Passion (PPP1/VER.A2, Japan) */
...
//N DRIVER( sws99 )     /* 1999.05 Super World Stadium '99 (SS91/VER.A3, Japan) */
    DRIVER( ghlpanic )  /* 1999.?? Ghoul Panic (OB2/VER.A) */
                        /* 1999.07 Oh Bakyuun (OB1, Japan) */
//N DRIVER( pacapp2 )   /* 1999.07 Paca Paca Passion 2 (PKS1/VER.A, Japan) */
...
//N DRIVER( mrdrillr )  /* 1999.11 Mr Driller (DRI1/VER.A2, Japan) */
                        /* 1999.12 UmJammer Lammy NOW! (Japan) */
                        /* 1999.12 Quest for Fame (Japan) */
//N DRIVER( pacappsp )  /* 1999.12 Paca Paca Passion Special (PSP1/VER.A, Japan) */
//# DRIVER( kaiunqz )   /* 1999.12 Kaiun Quiz (KW1/VER.A, Japan) */
//N DRIVER( aquarush )  /* 2000.02 Aqua Rush (AQ1/VER.A1, Japan) */
//N DRIVER( golgo13 )   /* 2000.03 Golgo 13 (GLG1/VER.A, Japan) */
//# DRIVER( sws2000 )   /* 2000.03 Super World Stadium 2000 (SS01/VER.A, Japan) */
                        /* 2000.06 Truck Kyousoukyoku (Metro) */
                        /* 2000.07 Kart Duel */
                        /* 2000.08 Teknowerk */
//N DRIVER( g13knd )    /* 2000.10 Golgo 13 Kiseki no Dandou (GLS1/VER.A, Japan) */
...
//# DRIVER( gamshara )  /* 2002.08 Gamshara (10021 Ver.A) */
    ...
    /* Konami GQ */
//N DRIVER( cryptklr )  /* Crypt Killer (GQ420 UAA) */
    /* Konami GV */
/**/DRIVER( konamigv )  /* BIOS */
//# DRIVER( kdeadeye )  /* GV054, UA01 */
//N DRIVER( pbball96 )  /* GV017, Japan 1.03 */
//N DRIVER( hyperath )  /* GV021, Japan 1.00 */
//N DRIVER( susume )    /* GV027, Japan 1.20 */
//# DRIVER( btchamp )   /* GV053, UAA01 */
//N DRIVER( weddingr )  /* GX624, JAA */
//# DRIVER( tokimosh )  /* GE755, JAA */
//# DRIVER( tokimosp )  /* GE756, JAB */
//N DRIVER( nagano98 )  /* GX720, EAA */
//N DRIVER( simpbowl )  /* GQ829, UAA */
    /* Konami System 573 */
//U DRIVER( sys573 )    /* BIOS */
//N DRIVER( darkhleg )  /* 1998 - Dark Horse Legend (GX706 VER. JAA) */
//N DRIVER( fbaitbc )   /* 1998 - Fisherman's Bait - A Bass Challenge (GE765 VER. UAB) */
//- DRIVER( bassangl )  /* 1998 - Bass Angler (GE765 VER. JAA) */
//N DRIVER( pbballex )  /* 1998 - Powerful Pro Baseball EX (GX802 VER. JAB) */
//N DRIVER( konam80s )  /* 1998 - Konami 80's AC Special (GC826 VER. EAA) */
...
//N DRIVER( dstage )    /* 1999 - Dancing Stage (GN845 VER. EAA) */
...
//N DRIVER( fbait2bc )  /* 1998 - Fisherman's Bait 2 - A Bass Challenge (GE865 VER. UAB) */
//- DRIVER( bassang2 )  /* 1998 - Bass Angler 2 (GE865 VER. JAA) */
//# DRIVER( drmn )      /* 1999 - DrumMania (GQ881 VER. JAD) */
//N DRIVER( gtrfrks )   /* 1999 - Guitar Freaks (GQ886 VER. EAC) */
...
//N DRIVER( fbaitmc )   /* 1999 - Fisherman's Bait - Marlin Challenge (GX889 VER. EA) */
...
//N DRIVER( ddr2m )     /* 1999 - Dance Dance Revolution 2nd Mix (GN895 VER. JAA) */
...
//N DRIVER( gtrfrk2m )  /* 1999 - Guitar Freaks 2nd Mix Ver 1.01 (GQ883 VER. JAD) */
//N DRIVER( dsftkd )    /* 1999 - Dancing Stage featuring TRUE KiSS DESTiNATiON (G*884 VER. JAA) */
//N DRIVER( cr589fw )   /* 1999 - CR-589 Firmware (700B04) */
//N DRIVER( cr589fwa )  /* 1999 - CR-589 Firmware (700A04) */
...
//N DRIVER( hyperbbc )  /* 1999 - Hyper Bishi Bashi Champ (GX908 1999/08/24 VER. JAA) */
//- DRIVER( hyperbbck ) /* 1999 - Hyper Bishi Bashi Champ (GX908 1999/08/24 VER. KAA) */
//U DRIVER( dsfdct )    /* 1999 - Dancing Stage featuring Dreams Come True (GC910 VER. JCA) */
//N DRIVER( dsfdcta )   /* 1999 - Dancing Stage featuring Dreams Come True (GC910 VER. JAA) */
...
//N DRIVER( salarymc )  /* 2000 - Salary Man Champ (G*A18 VER. JAA) */
...
//# DRIVER( mfightcc )  /* 2002 */
    ...
    /* Mitchell games */
#ifdef __GAME__CAPCOM__
//N DRIVER( mgakuen )   /* (c) 1988 Yuga */
//- DRIVER( 7toitsu )   /* (c) 1988 Yuga */
//N DRIVER( mgakuen2 )  /* (c) 1989 Face */
//N DRIVER( pkladies )  /* (c) 1989 Mitchell */
//- DRIVER( pkladiesl ) /* (c) 1989 Leprechaun */
//- DRIVER( pkladiesla )/* (c) 1989 Leprechaun */
//N DRIVER( dokaben )   /*  3/1989 (c) 1989 Capcom (Japan) */
...
//N DRIVER( cbasebal )  /* 10/1989 (c) 1989 Capcom (Japan) (different hardware) */
//N DRIVER( cworld )    /* 11/1989 (QUIZ 1) (c) 1989 Capcom */
//N DRIVER( hatena )    /* 28/02/1990 (QUIZ 2) (c) 1990 Capcom (Japan) */
...
//N DRIVER( marukin )   /* 17/10/1990 (c) 1990 Yuga (Japan) */
//N DRIVER( qtono1 )    /* 25/12/1990 (QUIZ 3) (c) 1991 Capcom (Japan) */
                        /*  4/1991 Ashita Tenki ni Naare (golf) */
//N DRIVER( qsangoku )  /* 07/06/1991 (QUIZ 4) (c) 1991 Capcom (Japan) */
...
//N DRIVER( wfortune )  /* (c) 1989 GameTek */
//- DRIVER( wfortunea ) /* (c) 1989 GameTek */
    DRIVER( grmatch )   /* (c) 1989 GameTek */
//N DRIVER( stratab )   /* (c) 1990 Strata/Incredible Technologies */
//- DRIVER( stratab1 )  /* (c) 1990 Strata/Incredible Technologies */
//N DRIVER( sstrike )   /* (c) 1990 Strata/Incredible Technologies */
//N DRIVER( gtg )       /* (c) 1990 Strata/Incredible Technologies */
...
//N DRIVER( slikshot )  /* (c) 1990 Grand Products/Incredible Technologies */
...
//N DRIVER( dynobop )   /* (c) 1990 Grand Products/Incredible Technologies */
//N DRIVER( arlingtn )  /* (c) 1991 Strata/Incredible Technologies */
    DRIVER( peggle )    /* (c) 1991 Strata/Incredible Technologies */
//- DRIVER( pegglet )   /* (c) 1991 Strata/Incredible Technologies */
//N DRIVER( pokrdice )  /* (c) 1991 Strata/Incredible Technologies */
//N DRIVER( rimrockn )  /* (c) 1991 Strata/Incredible Technologies */
...
//N DRIVER( gpgolf )    /* (c) 1992 Strata/Incredible Technologies */
//N DRIVER( gtg2 )      /* (c) 1992 Strata/Incredible Technologies */
...
//N DRIVER( hardyard )  /* (c) 1993 Strata/Incredible Technologies */
...
//N DRIVER( pairs )     /* (c) 1994 Strata/Incredible Technologies */
...
//N DRIVER( wcbowl )    /* (c) 1995 Incredible Technologies */
...
//N DRIVER( shufshot )  /* (c) Strata/Incredible Technologies */
//- DRIVER( shufshot139 )   /* (c) Strata/Incredible Technologies */
//- DRIVER( shufshot137 )   /* (c) Strata/Incredible Technologies */
//N DRIVER( wcbowldx )  /* (c) 1999 Incredible Technologies */
//N DRIVER( gt3d )      /* (c) 1995 Incredible Technologies */
...
//N DRIVER( gt97 )      /* (c) 1997 Incredible Technologies */
...
//N DRIVER( gt98 )      /* (c) 1998 Incredible Technologies */
...
//N DRIVER( gt99 )      /* (c) 1999 Incredible Technologies */
...
//N DRIVER( gt2k )      /* (c) 2000 Incredible Technologies */
...
//N DRIVER( sspacaho )  /* ? epr00001.bin - epr00008.bin */
...
//N DRIVER( samurai )   /* 289-302 + upgrades (c) 1980 Sega */
...
//N DRIVER( tokisens )  /* (c) 1987 (from a bootleg board) (S2) */
//N DRIVER( wbml )      /* bootleg (S2) */
...
//N DRIVER( dakkochn )  /* 836-6483? (S2) */
//N DRIVER( ufosensi )  /* 834-6659 (S2) */
...
//N DRIVER( ridleofp )  /* (c) 1986 Sega / Nasco */
    DRIVER( fantzn2 )   /* (c) 1988 */
    DRIVER( opaopa )
//N DRIVER( tetrisse )  /* (c) 1988 */
    /* other Sega 8-bit games */
//N DRIVER( turbo )     /* (c) 1981 Sega */
//- DRIVER( turboa )    /* (c) 1981 Sega */
//- DRIVER( turbob )    /* (c) 1981 Sega */
//N DRIVER( subroc3d )  /* (c) 1982 Sega */
...
//N DRIVER( mjleague )  /* (c) 1985 */
//N DRIVER( quartet )   /* (c) 1986 (8751) */
//- DRIVER( quarteta )  /* (c) 1986 (8751) */
//N DRIVER( quartet2 )  /* (c) 1986 (8751) */
...
//N DRIVER( bullet )    /* (c) 1987 (protected) */
...
//N DRIVER( exctleag )  /* (protected) */
//N DRIVER( fpoint )    /* (c) 1989 (Japan, FD1094, decrypted) */
...
//N DRIVER( sjryuko )   /* (c) 1988 White Board (FD1094, decrypted) */
//N DRIVER( suprleag )  /* (c) 1987 (protected) */
//- DRIVER( tetris2 )   /* (c) 1988 (FD1094, decrypted) S16B */
//- DRIVER( tetris1 )   /* (c) 1988 (FD1094, decrypted) S16B */
    DRIVER( timescan )  /* (c) 1987 */
//N DRIVER( toryumon )  /* (c) 1995 */
//N DRIVER( tturf )     /* (c) 1989 Sega / Sunsoft (8751) */
...
//N DRIVER( bloxeed )   /* 1989.12 Bloxeed (Japan, FD1094, decrypted) */
                        /* 1990.04 Bloxeed (US) */
...
//N DRIVER( lghost )    /* 1990.?? Laser Ghost (World, FD1094, decrypted) */ 
                        /* 1990.12 Laser Ghost (Japan) */
//- DRIVER( lghostu )   /* 1991.01 Laser Ghost (US, FD1094, decrypted) */
//N DRIVER( cltchitr )  /* 1991.02 Clutch Hitter (US, FD1094, decrypted) */
...
//N DRIVER( wwallyj )   /* 1992.06 Wally wo Sagase! (Japan, FD1094, decrypted) */
...
//N DRIVER( loffire )   /* 1989.?? Line of Fire (World, FD1094, decrypted) */
...
//N DRIVER( strkfgtr )  /* 1991.06 Strike Fighter (Japan) */
...
//N DRIVER( sgmastj )   /* 1989.06 Jumbo Ozaki Super Masters (Japan, FD1094, decrypted) */
/**/DRIVER( sgmast )    /* 1989.?? Super Masters Golf (World, protected) */
//N DRIVER( sgmastc )   /* 1989.?? Jumbo Ozaki Super Masters Golf (World, FD1094, decrypted) */
                        /* 1989.09 Super Masters Golf (US) */
//N DRIVER( roughrac )  /* 1990.03 Rough Racer (Japan, FD1094, decrypted) */
//- DRIVER( bnzabrosj ) /* 1990.06 Bonanza Bros. (Japan) */
    DRIVER( bnzabros )  /* 1990.08 Bonanza Bros. (US) */
//N DRIVER( qsww )      /* 1991.02 Quiz Syukudai wo Wasuremashita! (Japan) */
//- DRIVER( dcclubfd )  /* 1991.07 Dynamic Country Club (US) */
    /* ROM based */
//- DRIVER( dcclubj )   /* 1991.06 Dynamic Country Club (Japan) */
//N DRIVER( dcclub )    /* 1991.?? Dynamic Country Club (World) */
//N DRIVER( qrouka )    /* 1991.12 Quiz Rouka ni Tattenasai! (Japan) */
//N DRIVER( mahmajn )   /* 1992.12 Tokorosan no Mahmahjong (Japan) */
//N DRIVER( quizmeku )  /* 1993.05 Quiz Mekurumeku Story (Japan) */
//N DRIVER( mahmajn2 )  /* 1994.05 Tokorosan no Mahmahjong 2 (Japan) */
//N DRIVER( qgh )       /* 1994.09 Quiz Ghost Hunter */
...
//N DRIVER( sonic )     /* 1993.09 Sonic the Hedgehog (Japan) */
...
//N DRIVER( suikoenb )  /* 1995.03 Suiko Enbu (Data East) */
//N DRIVER( bakubaku )  /* 1995.04 Bakubaku Animal */
//# DRIVER( vfremix )   /* 1995.06 Virtua Fighter Remix */
//N DRIVER( ejihon )    /* 1995.07 Ejihon Tantei Jimusyo */
//# DRIVER( finlarch )  /* 1995.07 Final Arch */
//# DRIVER( sfish2j )   /* 1995.08 Sports Fishing 2 (Japan) */
//N DRIVER( shanhigw )  /* 1995.08 Shanghai Banri no Choujou */
//N DRIVER( sandor )    /* 1995.11 Nido Aru Koto wa Sando-R */
//N DRIVER( kiwames )   /* 1995.11 Pro Mahjong Kiwame S (Athena) */
//# DRIVER( sfish2 )    /* 1995.11 Sports Fishing 2 (Export) */
//N DRIVER( critcrsh )  /* 1995.?? Critter Crusher */
                        /* 1995.12 Tatakott */
    DRIVER( batmanfr )  /* 1996.02 Batman Forever (Acclaim) */
//N DRIVER( fhboxers )  /* 1996.02 Funky Head Boxers */
//N DRIVER( vfkids )    /* 1996.03 Virtua Fighter Kids */
//N DRIVER( pblbeach )  /* 1996.03 Pebble Beach the Great Shot (T&E Soft) */
//N DRIVER( introdon )  /* 1996.04 Karaoke Quiz Intro Dondon (Sunsoft / Success) */
//# DRIVER( smleague )  /* 1996.04 Super Major League */
//# DRIVER( decathlt )  /* 1996.05 Decathlete */
//# DRIVER( decathlto )
//- DRIVER( dnmtdeka )  /* 1996.07 Dynamite Deka */
//N DRIVER( mausuke )   /* 1996.07 Mausuke no Ojama the World (Data East) */
    DRIVER( diehard )   /* 1996.08 Die Hard Arcade */
//N DRIVER( sokyugrt )  /* 1996.09 Soukyuu Gurentai (Raizing / 8ing) */
//N DRIVER( prikura )   /* 1996.10 Prikura Daisakusen (Atlus) */
//# DRIVER( magzun )    /* 1996.11 Magical Zunou Power */
//N DRIVER( puyosun )   /* 1996.12 Puyo Puyo SUN (Compile) */
//N DRIVER( colmns97 )  /* 1997.01 Columns 97 */
    DRIVER( shienryu )  /* 1997.02 Shienryu (Warashi) */
//N DRIVER( vmahjong )  /* 1997.02 Virtual Mahjong (Micronet) */
...
//- DRIVER( thuntk )
//N DRIVER( winterht )  /* 1997.10 Winter Heat (Data East) */
//N DRIVER( cotton2 )   /* 1997.11 Cotton 2 (Success) */
//N DRIVER( hanagumi )  /* 1997.11 Sakura Taisen Hanagumi Taisen Columns */
//# DRIVER( findlove )  /* 1997.12 Find Love (Daiki / FCF) */
//N DRIVER( maruchan )  /* 1997.12 Maruchan de Goo!!! */
//# DRIVER( techbowl )  /* 1997.12 Technical Bowling */
//N DRIVER( znpwfv )    /* 1997.12 Zen Nippon Pro Wrestling featuring Virtua */
//N DRIVER( seabass )   /* 1998.02 Sea Bass Fishing (A wave Inc (Able License)) */
//N DRIVER( sasissu )   /* 1998.02 Taisen Tanto-R Sasissu!! */
                        /* 1998.03 Bass Master Challenge */
//# DRIVER( twcup98 )   /* 1998.04 Tecmo World Cup '98 (Tecmo) */
//N DRIVER( grdforce )  /* 1998.05 Guardian Force (Success) */
//N DRIVER( rsgun )     /* 1998.05 Radient Silver Gun (Treasure) */
//N DRIVER( astrass )   /* 1998.06 Astra Super Stars (Sunsoft) */
//N DRIVER( myfairld )  /* 1998.07 My Fair Lady (Micronet) */
//N DRIVER( othellos )  /* 1998.07 Othello Shiyouyo (Success) */
//N DRIVER( cottonbm )  /* 1998.09 Cotton Boomerang (Success) */
//# DRIVER( stress )    /* 1998.10 Stress Busters */
//# DRIVER( elandore )  /* 1998.11 Touryuu Densetsu Elandore (Sai-Mate) */
//N DRIVER( sss )       /* 1998.12 Steep Slope Sliders (Capcom / Cave / Victor) */
//# DRIVER( micrombc )  /* 1999.03 Microman Battle Charge */
//- DRIVER( sanjeon )   /* 1999.04 Sanjun Sujun (Sega / Deniam) */
//N DRIVER( danchih )   /* 1999.06 Danchi de Hanafuda Okusan Komeya Desuyo! (Altron (Tecmo License)) */
//# DRIVER( ffreveng )  /* 1999.09 Final Fight Revenge (Capcom) */
//N DRIVER( danchiq )   /* 2000.12 Danchi de Quiz Okusan Yontaku Desuyo! (Altron) */
    /* Sega Model 2 Games */
...
//N DRIVER( logicpro )  /* (c) 1996 Deniam */
//N DRIVER( croquis )   /* (c) 1996 Deniam (Germany) */
    DRIVER( karianx )   /* (c) 1996 Deniam */
//N DRIVER( logicpr2 )  /* (c) 1997 Deniam (Japan) */
/*
...
//N DRIVER( stkclmns )  /* (c) 1994 Sega */
//- DRIVER( stkclmnsj ) /* (c) 1994 Sega */
//N DRIVER( puyopuy2 )  /* (c) 1994 Compile + Sega license */
//N DRIVER( potopoto )  /* (c) 1994 Sega */
//N DRIVER( zunkyou )   /* (c) 1994 Sega */
...
//N DRIVER( topshoot )  /* (c) 1995 Sun Mixing */
...
//U DRIVER( naomi )		/* BIOS */
//U DRIVER( naomigd )	/* BIOS */
//U DRIVER( naomi2 )	/* BIOS */
//U DRIVER( hod2bios )  /* 1998.11 The House of the Dead 2 */
...
//N DRIVER( dolphin  )  /* 2003.08 Dolphin Blue */
//N DRIVER( ggisuka )   /* 2003.12 Guilty Gear Isuka */
                        /* 2003.12 Sangoku Senki Shichisei Tensei (IGS) */
//N DRIVER( rumblef )   /* 2004.03 The Rumble Fish */
...
//N DRIVER( kov7sprt )  /* 2004.?? Knights of Valour - The Seven Sprits */
...
//U DRIVER( decocass )  /* BIOS */
//N DRIVER( ctsttape )  /* ? */
//N DRIVER( chwy )      /* 01 1980.12 Highway Chase */
                        /* 02 1980.12 Sengoku Ninjatai */
                        /* 03 1981.01 Manhattan */
//N DRIVER( cterrani )  /* 04 1981.02 Terranian */
                        /* 05 1981.?? Missile Sprinter */
                        /* 06 1980.12 Nebbler */
//N DRIVER( castfant )  /* 07 1981.02 Astro Fantasia */
                        /* 08 1981.03 The Tower */
//N DRIVER( csuperas )  /* 09 1981.05 Super Astro Fighter */
                        /* 10 1981.?? Ocean to Ocean (medal) */
//N DRIVER( clocknch )  /* 11 1981.04 Rock'n Chase */
                        /* 12 1981.08 Flash Boy/DECO Kid */
//N DRIVER( cprogolf )  /* 13 1981.08 Pro Golf */
                        /* 14 1981.06 DS Telejan */
//N DRIVER( cluckypo )  /* 15 1981.?? Lucky Poker */
//N DRIVER( ctisland )  /* 16 1982.02 Treasure Island */
//- DRIVER( ctisland2 ) /* 16 */
//# DRIVER( ctisland3 ) /* 16 */
                        /* 17 1981.10 Bobbit */
//# DRIVER( cexplore )  /* 18 1982.02 Explorer */
//N DRIVER( cdiscon1 )  /* 19 1982.04 Disco No.1 */
//- DRIVER( csweetht )  /* 19 */
//N DRIVER( ctornado )  /* 20 1982.05 Tornado */
//N DRIVER( cmissnx )   /* 21 1982.04 Mission X/Zoar */
//N DRIVER( cptennis )  /* 22 1982.06 Pro Tennis */
                        /* 23 1982.?? 18 Hole Pro Golf */
                        /* 24 1982.07 Tsumego Kaisyou */
                        /* 25 1982.10 Fishing */
//N DRIVER( cbtime )    /* 26 1982.08 Hamburger/Burger Time */
//N DRIVER( cburnrub )  /* 27 1982.11 Burnin' Rubber/Bump'n Jump */
//- DRIVER( cburnrub2 ) /* 27 */
//- DRIVER( cbnj )      /* 27 */
//N DRIVER( cgraplop )  /* 28 1982.11 Grapelop */
//# DRIVER( cgraplop2 ) /* 28 */
//N DRIVER( clapapa )   /* 29 1982.11 Lapapa/Rootin' Tootin' */
//- DRIVER( clapapa2 )  /* 29 */ /* this one doesn't display lapapa anyehere */
                        /* 30 1983.03 Skater */
//N DRIVER( cprobowl )  /* 31 1983.03 Pro Bowling */
//N DRIVER( cnightst )  /* 32 1983.04 Night Star */
//- DRIVER( cnightst2 ) /* 32 */
//N DRIVER( cprosocc )  /* 33 1982.08 Pro Soccer */
                        /* 34 1983.09 Super Doubles Tennis */
//N DRIVER( cflyball )  /* 35 1983.?? Bampoline/Flying Ball */
                        /* 36 1984.04 Genesis/Boomer Rang'r */
//N DRIVER( czeroize )  /* 37 1983.10 Zeroize */ /* doesn't work at all */
//N DRIVER( cscrtry )   /* 38 1984.03 Scrum Try */
//- DRIVER( cscrtry2 )  /* 38 */
//N DRIVER( cppicf )    /* 39 1984.02 Peter Pepper's Ice Cream Factory */
//- DRIVER( cppicf2 )   /* 39 */
//N DRIVER( cfghtice )  /* 40 1984.04 Fighting Ice Hockey */
                        /* 41 1984.05 Oozumou */
                        /* 42 1984.08 Hellow Gateball */ /* not a typo, this is official spelling */
                        /* 43 1984.08 Yellow Cab */
//N DRIVER( cbdash )    /* 44 1985.08 Boulder Dash */
...
//N DRIVER( sidepckt )  /* (c) 1986 Data East Corporation */
...
//N DRIVER( pcktgal )   /* (c) 1987 Data East Corporation (Japan) */
...
//N DRIVER( pokechmp )  /* Korean hack of Pocket Gal */
...
//N DRIVER( birdtry )   /* (c) 1988 Data East Corporation (Japan) */
...
//N DRIVER( stadhero )  /* (c) 1988 Data East Corporation (Japan) */
...
//N DRIVER( chinatwn )  /* MAK (c) 1991 Data East Corporation (Japan) */
...
//N DRIVER( wlstar )    /* (c) 1995 Mijin */
//N DRIVER( wondl96 )   /* (c) 1996 SemiCom */
...
//N DRIVER( semibase )  /* (c) 1997 SemiCom */
//N DRIVER( dquizgo )   /* (c) 1998 SemiCom */
...
//N DRIVER( pktgaldx )  /* MAZ (c) 1993 Data East (Euro v3.00) */
...
//- DRIVER( joemacra )  /* MBN (c) 1994 */
                        ...
                        /* MBP ?? */
                        /* MBQ ?? */
//N DRIVER( tattass )   /* prototype (c) 1994 Data East Pinball (US) */
//- DRIVER( tattassa )  /* prototype (c) 1994 Data East Pinball (Asia) */
    DRIVER( charlien )  /* MBR (c) 1994 Mitchell */
                        ...
                        /* MBV ?? */
                        /* MBW ?? */
//N DRIVER( wcvol95 )   /* MBX (c) 1993 Data East */
                        /* MBY ?? */
//N DRIVER( backfire )  /* MBZ (c) 1995 */
//- DRIVER( backfirea ) /* MBZ (c) 1995 */
                        /* MCA ?? */
//N DRIVER( prtytime )  /* MCB (c) 1995 Mitchell */
...
//N DRIVER( sotsugyo )  /*     (c) 1995 Mitchell (Atlus license) */
/**/DRIVER( sshangha )  /*     (c) 1992 Hot-B */
//N DRIVER( sshanghab ) /* bootleg */
    /* Data East MLC Games */
//N DRIVER( hoops96 )   /* MCE (c) 1996 Data East Corporation */
//- DRIVER( ddream95 )  /* MCE (c) 1996 Data East Corporation */
//- DRIVER( hoops95 )   /* MCE (c) 1996 Data East Corporation */
//N DRIVER( avengrgs )  /* MCG (c) 1995 Data East Corporation (World) */
...
//N DRIVER( tbowl )     /* 6206 - (c) 1987 Tecmo */
...
//N DRIVER( wildfang )  /* (c) 1989 Tecmo */
//- DRIVER( tknight )   /* (c) 1989 Tecmo */
//N DRIVER( stratof )   /* (c) 1991 Tecmo */
...
//N DRIVER( spbactn )   /* 9002 - (c) 1991 Tecmo */
//- DRIVER( spbactnj )  /* 9002 - (c) 1991 Tecmo */
    DRIVER( fstarfrc )  /* (c) 1992 Tecmo */
//- DRIVER( fstarfrcj ) /* (c) 1992 Tecmo */
//N DRIVER( ginkun )    /* (c) 1995 Tecmo */
//N DRIVER( deroon )    /* (c) 1996 Tecmo */
//N DRIVER( tkdensho )  /* (c) 1996 Tecmo */
...
//N DRIVER( pingpong )  /* GX555 (c) 1985 */
//N DRIVER( merlinmm )  /* (c) 1986 Zilec-Zenitone */
//N DRIVER( cashquiz )  /* (c) 1986 Zilec-Zenitone */
    DRIVER( gberet )    /* GX577 (c) 1985 */
//- DRIVER( rushatck )  /* GX577 (c) 1985 */
//- DRIVER( gberetb )   /* bootleg on different hardware */
//N DRIVER( mrgoemon )  /* GX621 (c) 1986 (Japan) */
...
//N DRIVER( rackemup )  /* GX765 (c) 1987 */
...
//N DRIVER( esckids )   /* GX975 (c) 1991 (Asia) */
//- DRIVER( esckidsj )  /* GX975 (c) 1991 (Japan) */
//N DRIVER( vendetta )  /* GX081 (c) 1991 (World) */
...
//N DRIVER( tgtpanic )  /* GX601 (c) 1996 */
...
//N DRIVER( mmaulers )  /* GX170 (c) 1993 (Europe) */
//- DRIVER( dadandrn )  /* GX170 (c) 1993 (Japan) */
//N DRIVER( metamrph )  /* GX224 (c) 1993 (Europe) */
//- DRIVER( metamrphu ) /* GX224 (c) 1993 (US) */
//- DRIVER( metamrphj ) /* GX224 (c) 1993 (Japan) */
//N DRIVER( mtlchamp )  /* GX234 (c) 1993 (World) */
...
//N DRIVER( rungun )    /* GX247 (c) 1993 (World) */
...
//N DRIVER( bishi )     /* GX575 (c) 1996 (Japan) */
//N DRIVER( sbishi )    /* GX675 (c) 1998 (Japan) */    
//- DRIVER( sbishik )   /* GX675 (c) 1998 (Korea) */
    /* Konami dual 68000 games */
//# DRIVER( overdriv )  /* GX789 (c) 1990 */
//N DRIVER( gradius3 )  /* GX945 (c) 1989 (Japan) */
...
//# DRIVER( ggreats2 )  /* 1994.03 GX218 (Japan) */
                        /* 1995.03 GX218 (US) */
    /* GX Type 2 */
//N DRIVER( le2 )       /* 1994.?? GX312 (Europe) */
//- DRIVER( le2u )      /* 1994.04 GX312 (US) */
//# DRIVER( le2j )      /* 1994.06 GX312 (Japan) */
//N DRIVER( puzldama )  /* 1994.07 GX315 (Japan) */
//N DRIVER( gokuparo )  /* 1994.04 GX321 (Japan) */
//- DRIVER( fantjour )  /* 1994.?? GX321 (US?) */
//N DRIVER( dragoona )  /* 1995.?? GX417 (Asia) */
//- DRIVER( dragoonj )  /* 1995.08 GX417 (Japan) */
//N DRIVER( tbyahhoo )  /* 1995.04 GX424 (Japan) */
//N DRIVER( tkmmpzdm )  /* 1995.12 GX515 (Japan) */
//N DRIVER( salmndr2 )  /* 1996.01 GX521 (Japan) */
//- DRIVER( salmndr2a ) /* 1996.?? GX521 (Asia) */
//N DRIVER( sexyparo )  /* 1996.02 GX533 (Japan) */
//N DRIVER( daiskiss )  /* 1996.03 GX535 (Japan) */
//N DRIVER( tokkae )    /* 1996.10 GX615 (Japan) */
//N DRIVER( winspike )  /* 1997.?? GX705 (Europe) */
//- DRIVER( winspikej ) /* 1997.07 GX705 (Japan) */
    /* GX Type 3 */
//N DRIVER( soccerss )  /* 1994.?? GX427 (Europe) */
...
//N DRIVER( rungun2 )   /* 1996.03 GX505 (US) */
//- DRIVER( slamdnk2 )  /* 1996.03 GX505 (Japan) */
//N DRIVER( rushhero )  /* 1997.10 GX605 (US) */
    /* 68k + HD */
//N DRIVER( qdrmfgp )   /* 1994.12 GQ460 (Japan) */
//N DRIVER( qdrmfgp2 )  /* 1995.09 GE557 (Japan) */
    /* DJ Main */
//N DRIVER( bm1stmix )  /* GQ753 (c) 1997 (Japan) */
//N DRIVER( bm2ndmix )  /* GX853 (c) 1998 (Japan) */
//- DRIVER( bm2ndmxa )  /* GX853 (c) 1998 (Japan) */
//N DRIVER( bm3rdmix )  /* GX853 (c) 1998 (Japan) */
//  DRIVER( bm3rdmxb )  /* GX853 (c) 1998 (Japan) */
//N DRIVER( bmcompmx )  /* GX858 (c) 1999 (Japan) */
//- DRIVER( hmcompmx )  /* GX858 (c) 1999 */
//N DRIVER( bm4thmix )  /* GX847 (c) 1999 (Japan) */
//N DRIVER( bm5thmix )  /* GX981 (c) 1999 (Japan) */
//N DRIVER( bmclubmx )  /* GX993 (c) 2000 (Japan) */
//N DRIVER( bmcorerm )  /* GXA05 (c) 1999 (Japan) */
//N DRIVER( bmdct )     /* GX995 (c) 2000 (Japan) */
//N DRIVER( bmcompm2 )  /* GX988 (c) 2000 (Japan) */
//- DRIVER( hmcompm2 )  /* GX988 (c) 2000 */
//N DRIVER( bm6thmix )  /* GXA21 (c) 2001 (Japan) */
//N DRIVER( bm7thmix )  /* GXB07 (c) 2001 (Japan) */
//N DRIVER( bmfinal )   /* GXC01 (c) 2002 (Japan) */
//  DRIVER( popn1 )     /* GX803 (c) 1998 (Japan) */
//N DRIVER( popn2 )     /* GX831 (c) 1998 (Japan) */
...
//N DRIVER( fiveside )  /* GX479 (c)1995 */
...
//N DRIVER( midnrun )   /* GX476 (c)1995 */
//N DRIVER( windheat )  /* GX677 (c)1996 */
...
//N DRIVER( robotbwl )  /* no copyright notice */
...
//- DRIVER( victorba )  /* (c) 1982 */
    ...
    /* Exidy 440 games */
//N DRIVER( crossbow )  /* (c) 1983 */
//N DRIVER( cheyenne )  /* (c) 1984 */
//N DRIVER( combat )    /* (c) 1985 */
//- DRIVER( catch22 )   /* (c) 1985 */
//N DRIVER( cracksht )  /* (c) 1985 */
//N DRIVER( claypign )  /* (c) 1986 */
//N DRIVER( chiller )   /* (c) 1986 */
//N DRIVER( topsecex )  /* (c) 1986 */
//N DRIVER( hitnmiss )  /* (c) 1987 */
//- DRIVER( hitnmiss2 ) /* (c) 1987 */
//N DRIVER( whodunit )  /* (c) 1988 */
//N DRIVER( showdown )  /* (c) 1988 */
//N DRIVER( yukon )     /* (c) 1989 */
//- DRIVER( yukon1 )    /* (c) 1989 */
    /* Exidy Max-A-Flex */
/**/DRIVER( maxaflex )  /* BIOS */
...
//N DRIVER( cball )     /* ?????? prototype 1976/?? [6800] */
...
//N DRIVER( skyraid )   /* 009709           1978/03 [6502] */
...
//N DRIVER( boxer )     /* ?????? prototype 1978    [6502] */
//N DRIVER( wolfpack )  /* ?????? prototype         [6502] */
//N DRIVER( mgolf )     /* ?????? prototype 1978    [6502] */
//N DRIVER( videopin )  /* 034253-034267    1979/02 [6502] */
...
//N DRIVER( quantum )   /* 136016           (c) 1982 */ /* made by Gencomp */
...
//N DRIVER( bullsdrt )  /* (c) 1985 Shinkai */
//# DRIVER( cmmb162 )
    /* misc Atari games */
...
//- DRIVER( apbf )      /* 136051           (c) 1987 */
    ...
    /* Hard Drivin' */
//N    DRIVER( harddriv )   /* 136052           (c) 1988 */
...
//- DRIVER( stunrunp )  /* (proto)          (c) 1989 */
    /* Race Drivin' */
//N DRIVER( racedriv )   /* 136077           (c) 1990 */
...
//- DRIVER( toobin1 )   /* 136061           (c) 1988 */
    /* Cyberball */
//N DRIVER( cyberbal )  /* 136064           (c) 1989 */
...
//N DRIVER( rampart )   /* 136082           (c) 1990 */
...
//N DRIVER( area51mx )  /* 136105           (c) 1998 */
//- DRIVER( a51mxr3k )  /*     ??           (c) 1998 */
//N DRIVER( maxforce )  /*     ??           (c) 1996 */
//- DRIVER( maxf_102 )  /*     ??           (c) 1996 */
//- DRIVER( maxf_ng )   /*     ??           (c) 1996 */
//N DRIVER( vcircle )   /* (proto)          (c) 1996 */
...
//N DRIVER( wwjgtin )   /* (c) 1984 Jaleco / Casio */
//- DRIVER( photof )    /* (c) 1984 Jaleco / Casio */
//N DRIVER( pinbo )     /* (c) 1984 Jaleco */
...
//N DRIVER( fitegolf )  /*       'GU' (c) 1988 */
//- DRIVER( fitegolfu ) /*       'GU' (c) 1988 */
//N DRIVER( countryc )  /* A7004 'CC' (c) 1988 */
...
//N DRIVER( bakatono )  /* 0036 (c) 1991 Monolith Corp. */
...
//N DRIVER( quizdai2 )  /* 0042 (c) 1992 SNK */
...
//N DRIVER( janshin )   /* 0048 (c) 1994 Aicom */
...
//N DRIVER( quizkof )   /* 0080 (c) 1995 Saurus */
...
//N DRIVER( turfmast )  /* 0200 (c) 1996 Nazca */
    DRIVER( mslug )     /* 0201 (c) 1996 Nazca */
    DRIVER( puzzledp )  /* 0202 (c) 1995 Taito (Visco license) */
//N DRIVER( mosyougi )  /* 0203 (c) 1995 ADK / SNK */
                        /* 0204 QP (prototype) */
                        /* 0205 Neo-Geo CD Special (CD only) */
//N DRIVER( marukodq )  /* 0206 (c) 1995 Takara */
...
//N DRIVER( matrim )    /* 0266 (c) 2002 Atlus */
//- DRIVER( matrimbl )  /* bootleg */
//N DRIVER( pnyaa )     /* 0267 (c) 2003 Aiky / Taito */
//N DRIVER( ms5pcb )    /* 0268 (c) 2003 Playmore */
    DRIVER( mslug5 )    /* 0268 (c) 2003 Playmore */
//- DRIVER( mslug5h )   /* 0268 (c) 2003 Playmore */
//- DRIVER( ms5plus )   /* bootleg */
//N DRIVER( svcpcb )    /* 0269 (c) 2003 Playmore / Capcom - JAMMA PCB */
...
//N DRIVER( kf2k3pcb )  /* 0271 (c) 2003 Playmore - JAMMA PCB */
...
//# DRIVER( buriki )    /* 007 1999/05/21 Buriki One */
    ...
    /* Alpha Denshi games */
#ifdef __GAME__ALPHA__
//N DRIVER( shougi )    /* (c) 1982 (Arcade TV Game List - P.80, Left, 9 from top) */
...
//N DRIVER( meijinsn )  /* (c) 1986 SNK */
#endif

    /* Technos games */
#ifdef __GAME__TECHNOS__
...
//N DRIVER( bigprowr )  /* TA-0007 (c) 1983 */
//- DRIVER( tagteam )   /* TA-0007 (c) 1983 + Data East license */
//N DRIVER( ssozumo )   /* TA-0008 (c) 1984 */
...
//N DRIVER( agress )    /* TA-0029 (c) 1991 Palco */
...
//# DRIVER( greatgun )  /* (c) 1983 */
    /* Other Stern */
//N DRIVER( supdrapo )  /* (c) 1983 */
//N DRIVER( cliffhgr )  /* (c) 1983 */
//- DRIVER( cliffhgra ) /* (c) 1983 */
//# DRIVER( goaltogo )  /* (c) 1983 */
#endif

    /* GamePlan games */
#ifdef __GAME__GAMEPLAN__
...
//N DRIVER( strahl )    /* UPL-91074 (c) 1992 UPL (Japan) */
...
//N DRIVER( daireika )  /* (c) 1989 Jaleco/NMK */
//N DRIVER( mjzoomin )  /* (c) 1990 */
//N DRIVER( kakumei )   /* (c) 1990 */
//N DRIVER( kakumei2 )  /* (c) 1992 */
//N DRIVER( suchipi )   /* (c) 1993 */
    /* NMK Double Dealer, Similar Hardware to Jaleco Mahjong games above */
//N DRIVER( ddealer )   /* (c) 1991 NMK */
    /* Based on nmk16? */
//N DRIVER( quizpani )  /* (c) 1993 NMK */
//# DRIVER( acommand )  /* (c) 1990 */
    /* don't know what hardare Banpresto used for these games */
    DRIVER( macrossp )  /* (c) 1996 Banpresto */
//N DRIVER( quizmoon )  /* (c) 1997 Banpresto */
    /* Face/NMK games */
//N DRIVER( gakupara )  /* (c) 1991 NMK */
//N DRIVER( quizdna )   /* (c) 1992 Face */
//N DRIVER( gekiretu )  /* (c) 1992 Face */
//N DRIVER( cultures )  /* (c) 1994 Face */
#endif
...
//- DRIVER( rmpgwt11 )  /* (c) 1997 Midway */
    /* Midway V-unit games */
//N DRIVER( crusnusa )  /* (c) 1994 Midway */
//- DRIVER( crusnusa40 )    /* (c) 1994 Midway */
//- DRIVER( crusnusa21 )    /* (c) 1994 Midway */
//N DRIVER( crusnwld )  /* (c) 1996 Midway */
...
//N DRIVER( wargods )   /* (c) 1996 Midway */
    /* Midway Zeus games */
...
//N DRIVER( wg3dh )     /* (c) 1996 Atari Games */
//N DRIVER( mace )      /* (c) 1996 Atari Games */
//- DRIVER( macea )     /* (c) 1996 Atari Games */
//N DRIVER( sfrush )    /* (c) 1996 Atari Games */
//# DRIVER( sfrushrk )  /* (c) 1996 Atari Games */
//N DRIVER( calspeed )  /* (c) 1996 Atari Games */
//- DRIVER( calspeeda ) /* (c) 1996 Atari Games */
//N DRIVER( vaportrx )  /* (c) 1998 Atari Games */
//- DRIVER( vaportrxp ) /* (c) 1998 Atari Games */
//N DRIVER( carnevil )  /* (c) 1998 Midway Games (v1.0.3) */
//- DRIVER( carnevil1 ) /* (c) 1998 Midway Games (v1.0.1) */
//N DRIVER( biofreak )  /* (c) 1997 Midway Games (prototype) */
//N DRIVER( blitz )     /* (c) 1997 Midway Games */
//- DRIVER( blitz11 )   /* (c) 1997 Midway Games */
//N DRIVER( blitz99 )   /* (c) 1998 Midway Games */
//N DRIVER( blitz2k )   /* (c) 1999 Midway Games */
//N DRIVER( hyprdriv )  /* (c) 1998 Midway Games */
    /* Midway / Atari  Voodoo 2 & 3 - based Hardware (Vegas, Denver, Durango) */
//N DRIVER( gauntleg )  /* (c) 1998 Atari Games */
//- DRIVER( gauntleg12 )    /* (c) 1998 Atari Games */
//N DRIVER( tenthdeg )  /* (c) 1998 Atari Games (prototype) */
...
//N DRIVER( gauntdl )   /* (c) 1999 Midway Games */
//- DRIVER( gauntdl24 ) /* (c) 1999 Midway Games */
//# DRIVER( cartfury )  /* (c) 2000 Midway Games */
    /* Midway Touchmaster / Galaxy Games */
//N DRIVER( tm )        /* (c) 1996 Midway Games */
//N DRIVER( tm2k )      /* (c) 1996 Midway Games */
//N DRIVER( tm3k )      /* (c) 1997 Midway Games */
//- DRIVER( tm3ka )     /* (c) 1997 Midway Games */
//N DRIVER( tm4k )      /* (c) 1998 Midway Games */
//N DRIVER( tm5k )      /* (c) 1998 Midway Games */
//- DRIVER( tm5kca )    /* (c) 1998 Midway Games */
//- DRIVER( tm5ka )     /* (c) 1998 Midway Games */
//N DRIVER( tm7k )      /* (c) 1999 Midway Games */
//- DRIVER( tm7ka )     /* (c) 1999 Midway Games */
//- DRIVER( tm7keval )  /* (c) 1999 Midway Games */
//N DRIVER( tm8k )      /* (c) 2000 Midway Games */
//U DRIVER( galgbios )  /* (c) 1998 Creative Electronics & Software (CES) */
//N DRIVER( galgame2 )  /* (c) 1998 Creative Electronics & Software (CES) / Namco */
#endif
    
    /* Cinematronics raster games */
#ifdef __GAME__CINEMAT__
    DRIVER( embargo )
//N DRIVER( tripool )   /* (c) 1981 Noma (Casino Tech license) */
//- DRIVER( tripoola )  /* (c) 1981 Noma (Costal Games license) */
    DRIVER( joinem )    /* (c) 1986 Global */
    DRIVER( loverboy )  /* (c) 1983 Global */
//N DRIVER( striv )     /* (c) 1985 Hara Industries */
...
//N DRIVER( sucasino )  /* (c) 1982 Data Amusement */
    /* Cinematronics vector games */
//N DRIVER( spacewar )  /* (c) 1977 */
//N DRIVER( barrier )   /* (c) 1979 Vectorbeam */
//N DRIVER( starcas )   /* (c) 1980 */
...
//N DRIVER( tailg )     /* (c) 1979 */
//N DRIVER( ripoff )    /* (c) 1980 */
//N DRIVER( armora )    /* (c) 1980 */
//- DRIVER( armorap )   /* (c) 1980 */
//- DRIVER( armorar )   /* (c) 1980 Cinematronics (Rock-ola license) */
//N DRIVER( wotw )      /* (c) 1981 */
//- DRIVER( wotwc )     /* (c) 1981 */
//N DRIVER( warrior )   /* (c) 1979 Vectorbeam */
//N DRIVER( starhawk )  /* (c) 1979 */
//N DRIVER( solarq )    /* (c) 1981 */
//N DRIVER( boxingb )   /* (c) 1981 */
//N DRIVER( speedfrk )  /* (c) 1979 Vectorbeam */
//N DRIVER( sundance )  /* (c) 1979 */
//N DRIVER( demon )     /* (c) 1982 Rock-ola */
//N DRIVER( qb3 )       /* (c) 1982 Rock-ola - prototype */
...
//N DRIVER( rtriv )     /* (c) 198? Romar */
#endif
#ifdef __GAME__MISC__
//N DRIVER( koroleva )  /* (c) 1988 Terminal */
#endif

    /* TIA-MC1 hardware games */
#ifdef __GAME__MISC__
//N DRIVER( konek )     /* (c) 1988 Terminal */
//N DRIVER( sosterm )   /* (c) 1988 Terminal */
//N DRIVER( bilyard )   /* (c) 1988 Terminal */
...
//N DRIVER( dynduke )   /* (c) 1989 Seibu Kaihatsu + Fabtek license */
...
//N DRIVER( sengokmj )  /* (c) 1991 Sigma */
//N DRIVER( totmejan )  /* (c) 1991 Seibu/Tecmo */
//N DRIVER( goodejan )  /* (c) 1991 Seibu/Tecmo */
...
//N DRIVER( senkyu )    /* (c) 1995 Seibu Kaihatsu */
...
//N DRIVER( viprp1 )    /* (c) 1995 Seibu Kaihatsu */
...
//N DRIVER( ejanhs )    /* (c) 1996 Seibu Kaihatsu */
//N DRIVER( rdft )      /* (c) 1996 Seibu Kaihatsu */
...
//N DRIVER( rdft2 )     /* (c) 1997 Seibu Kaihatsu (Tuning License) */
...
//N DRIVER( rfjet )     /* (c) 1998 Seibu Kaihatsu (Tuning License) */
...
//N DRIVER( ejsakura )  /* (c) 1999 Seibu Kaihatsu */
//- DRIVER( ejsakura12 )    /* (c) 1999 Seibu Kaihatsu */
    /* Seibu System SH2B games */
//N DRIVER( feversoc )  /* (c) 2000 */
...
//N DRIVER( ddayjlc )   /* (c) 1984 Jaleco */
...
//N DRIVER( rockn )     /* (c) 1999 Jaleco */
//- DRIVER( rockna )    /* (c) 1999 Jaleco */
//N DRIVER( rockn2 )    /* (c) 1999 Jaleco */
//N DRIVER( rocknms )   /* (c) 1999 Jaleco */
//N DRIVER( rockn3 )    /* (c) 1999 Jaleco */
//N DRIVER( rockn4 )    /* (c) 2000 Jaleco */
...
#ifdef __GAME__VSYSTEM__
//N DRIVER( rabiolep )  /* (c) 1987 V-System Co. (Japan) */
...
//N DRIVER( ojankoc )   /* [1986] V-System Co. (Japan) */
//N DRIVER( ojankoy )   /* [1986] V-System Co. (Japan) */
//N DRIVER( ojanko2 )   /* [1987] V-System Co. (Japan) */
//N DRIVER( ccasino )   /* [1987] V-System Co. (Japan) */
//N DRIVER( ojankohs )  /* [1988] V-System Co. (Japan) */
//N DRIVER( nekkyoku )  /* [1988] Video System Co. (Japan) */
//N DRIVER( idolmj )    /* [1988] (c) System Service (Japan) */
//N DRIVER( mjnatsu )   /* [1989] Video System presents (Japan) */
//- DRIVER( natsuiro )  /* [1989] Video System presents (Japan) */
//N DRIVER( mfunclub )  /* [1989] V-System (Japan) */
//N DRIVER( daiyogen )  /* [1990] Video System Co. (Japan) */
//N DRIVER( nmsengen )  /* (c) 1991 Video System (Japan) */
//N DRIVER( fromance )  /* (c) 1991 Video System Co. (Japan) */
...
//N DRIVER( quiz18k )   /* (c) 1992 EIM (Welltris hardware) */
...
//N DRIVER( gstriker )  /* (c) [1993] Human */
...
//N DRIVER( fromanc2 )  /* (c) 1995 Video System Co. (Japan) */
//N DRIVER( fromancr )  /* (c) 1995 Video System Co. (Japan) */
//N DRIVER( fromanc4 )  /* (c) 1998 Video System Co. (Japan) */
//N DRIVER( inufuku )   /* (c) 1998 Video System Co. (Japan) */
#endif
    
    /* Psikyo games */
#ifdef __GAME__PSIKYO__
...
//N DRIVER( mjgtaste )  /* (c) 2002 */
//N DRIVER( hotgmck )   /* (c) 1997 */
//N DRIVER( hgkairak )  /* (c) 1998 */
//N DRIVER( hotgmck3 )  /* (c) 1999 */
//N DRIVER( hotgm4ev )  /* (c) 2000 */
//N DRIVER( hotgmcki )  /* (c) 2001 */
    DRIVER( loderndf )  /* (c) 2000 */
//- DRIVER( loderndfa ) /* (c) 2000 */
//N DRIVER( hotdebut )  /* (c) 2000 */
#endif

    /* Orca games */
#ifdef __GAME__ORCA__
...
//N DRIVER( bcruzm12 )  /* (c) 1983 Sigma Ent. Inc. */
...
*/
    ...
    /* Gaelco 2D games */
#ifdef __GAME__GAELCO__
//N DRIVER( mastboy )   /* (c) 1987 - No Ref on the PCB */
//- DRIVER( mastboyi )  /* (c) 1987 - No Ref on the PCB */
//N DRIVER( xorworld )  /* (c) 1990 - prototype */
    DRIVER( bigkarnk )  /* (c) 1991 - Ref 901112-1 */
    /* Master Boy 2 */  /* (c) 1991 - Ref ??? */
//N DRIVER( splash )    /* (c) 1992 - Ref 922804 */
//- DRIVER( splash10 )  /* (c) 1992 - Ref 922804 */
//- DRIVER( paintlad )  /* (c) 1992 - ver 1.3 */
//N DRIVER( roldfrog )  /* not a gaelco game but based on splash code */
...
//N DRIVER( targeth )   /* (c) 1994 - Ref 940531 */
...
//N DRIVER( galpanic )  /* (c) 1990 Kaneko */
//- DRIVER( galpanica ) /* (c) 1990 Kaneko */
//N DRIVER( galsnew )   /* (c) 1990 Kaneko */
...
//N DRIVER( galpani3 )  /* (c) 1995 Kaneko */
...
//N DRIVER( bonkadv )   /* (c) 1994 Kaneko */
...
/**/DRIVER( skns )      /* Bios */
//N DRIVER( galpani4 )  /* 1996.09 (c) 1996 Kaneko (Japan) */
//- DRIVER( galpani4k ) /* 1996.09 (c) 1996 Kaneko (Korea) */
//N DRIVER( jjparads )  /* 1996.12 (c) 1996 Electro Design Co. (Japan) */
//- DRIVER( sarukani )  /* 1997.01 (c) 1997 Kaneko / Mediaworks (Japan) */
//N DRIVER( vblokbrk )  /* 1997.?? (c) 1997 Kaneko / Mediaworks (Asia) */
//N DRIVER( galpanis )  /* 1997.04 (c) 1997 Kaneko (Japan) */
    DRIVER( sengekis )  /* 1997.?? (c) 1997 Kaneko / Warashi (Asia) */
//- DRIVER( sengekisj ) /* 1997.07 (c) 1997 Kaneko / Warashi (Japan) */
//N DRIVER( jjparad2 )  /* 1997.12 (c) 1997 Electro Design Co. (Japan) */
    DRIVER( cyvern )    /* 1998.02 (c) 1998 Kaneko (Japan) */
//N DRIVER( ryouran )   /* 1998.07 (c) 1998 Electro Design Co. (Japan) */
...
//N DRIVER( galpans2 )  /* 1999.02 (c) 1999 Kaneko (Japan) */
//- DRIVER( galpans2a ) /* 1999.?? (c) 1999 Kaneko (Asia) */
//- DRIVER( galpansu )  /* 1999.?? (c) 1999 Kaneko (Korea) */
//N DRIVER( senknow )   /* 1999.04 (c) 1999 Kaneko / Kouyousha (Japan) */
//N DRIVER( panicstr )  /* 1999.09 (c) 1999 Kaneko (Japan) */
//N DRIVER( teljan )    /* 1999.11 (c) 1999 Electro Design Co. (Japan) */
//N DRIVER( gutsn )     /* 2000.06 (c) 2000 Kaneko / Kouyousha (Japan) */
//N DRIVER( galpans3 )  /* 2002.07 (c) 2002 Kaneko (Japan) */
#endif

    /* Seta games (seta.c) */
#ifdef __GAME__SETA__
//N DRIVER( hanaawas )  /* (c) SetaKikaku */
//N DRIVER( speedatk )  /* CB-0 (c) SetaKikaku */
//N DRIVER( srmp1 )     /* UB or UC?? (c) 1987 */
//N DRIVER( srmp2 )     /* UB or UC?? (c) 1987 */
//N DRIVER( srmp3 )     /* ZA-0? (c) 1988 */
//N DRIVER( mjyuugi )   /* (c) 1990 Visco */
//- DRIVER( mjyuugia )  /* (c) 1990 Visco */
//N DRIVER( ponchin )   /* (c) 1991 Visco */
...
//N DRIVER( usclssic )  /* UE   (c) 1989 + Romstar or Taito license (DSW) */
...
//N DRIVER( wiggie )    /* (c) 1994 Promat (not genuine seta hardware, but based on thunderl code) */
//N DRIVER( jockeyc )   /* (c) 1990 [Seta] (Visco license) */
    DRIVER( rezon )     /* (c) 1991 Allumer */
//- DRIVER( rezont )    /* (c) 1991 Allumer / Taito */
    DRIVER( stg )       /* (c) 1991 Athena / Tecmo */
//N DRIVER( pairlove )  /* (c) 1991 Athena */
    DRIVER( blandia )   /* (c) 1992 Allumer */
//- DRIVER( blandiap )  /* (c) 1992 Allumer */
    DRIVER( blockcar )  /* (c) 1992 Visco */
//N DRIVER( qzkklogy )  /* (c) 1992 Tecmo */
//N DRIVER( neobattl )  /* (c) 1992 Banpresto / Sotsu Agency. Sunrise */
//N DRIVER( umanclub )  /* (c) 1992 Tsuburaya Prod. / Banpresto */
    DRIVER( zingzip )   /* UY   (c) 1992 Allumer + Tecmo */
//N DRIVER( atehate )   /* (C) 1993 Athena */
...
//N DRIVER( oisipuzl )  /* (c) 1993 SunSoft / Atlus */
//- DRIVER( triplfun )  /* bootleg */
    DRIVER( utoukond )  /* (c) 1993 Banpresto + Tsuburaya Prod. */
//N DRIVER( qzkklgy2 )  /* (c) 1993 Tecmo */
    DRIVER( wrofaero )  /* (c) 1993 Yang Cheng */
    DRIVER( eightfrc )  /* (c) 1994 Tecmo */
//N DRIVER( kiwame )    /* (c) 1994 Athena */
//N DRIVER( krzybowl )  /* (c) 1994 American Sammy */
    DRIVER( orbs )      /* (c) 1994 American Sammy */
//N DRIVER( keroppi )   /* (c) 1993 Sammy */
    DRIVER( extdwnhl )  /* (c) 1995 Sammy Japan */
//N DRIVER( gundhara )  /* (c) 1995 Banpresto */
//N DRIVER( sokonuke )  /* (c) 1995 Sammy Industries */
    DRIVER( zombraid )  /* (c) 1995 American Sammy */
//N DRIVER( crazyfgt )  /* (c) 1998 Subsino */
//# DRIVER( inttoote )  /* (c) 1998 Coinmaster */
//# DRIVER( inttootea ) /* (c) 1998 Coinmaster */
    /* Seta games (seta2.c) */
    DRIVER( gundamex )  /* (c) 1994 Banpresto */
//N DRIVER( grdians )   /* (c) 1995 Banpresto */
//N DRIVER( mj4simai )  /* (c) 1996 Maboroshi Ware */
//N DRIVER( myangel )   /* (c) 1996 Namco */
//N DRIVER( myangel2 )  /* (c) 1997 Namco */
//N DRIVER( pzlbowl )   /* (c) 1999 Nihon System / Moss */
//N DRIVER( penbros )   /* (c) 2000 Subsino */
//N DRIVER( deerhunt )  /* (c) 2000 Sammy USA Corporation */
...
//N DRIVER( turkhunt )  /* (c) 2001 Sammy USA Corporation */
//N DRIVER( wschamp )   /* (c) 2001 Sammy USA Corporation */
//- DRIVER( wschampa )  /* (c) 2001 Sammy USA Corporation */
//N DRIVER( funcube2 )  /* (c) 2001 Namco */
//N DRIVER( funcube4 )  /* (c) 2001 Namco */
//N DRIVER( trophyh )   /* (c) 2002 Sammy USA Corporation */
    /* SSV System (Seta, Sammy, Visco) games */
//N DRIVER( srmp4 )     /* (c) 1993 Seta */
//- DRIVER( srmp4o )    /* (c) 1993 Seta */
    DRIVER( twineag2 )  /* (c) 1994 Seta */
//N DRIVER( srmp7 )     /* (c) 1997 Seta */
    DRIVER( dynagear )  /* (c) 1993 Sammy */
    DRIVER( survarts )  /* (c) 1993 Sammy */
//- DRIVER( survartsu ) /* (c) 1993 Sammy (American) */
//N DRIVER( eaglshot )  /* (c) 1994 Sammy */
//N DRIVER( hypreact )  /* (c) 1995 Sammy */
//N DRIVER( meosism )   /* (c) 1996?Sammy */
//N DRIVER( hypreac2 )  /* (c) 1997 Sammy */
//N DRIVER( sxyreact )  /* (c) 1998 Sammy */
//N DRIVER( sxyreac2 )  /* (c) 1999 Sammy */
//N DRIVER( cairblad )  /* (c) 1999 Sammy */
//N DRIVER( keithlcy )  /* (c) 1993 Visco */
    DRIVER( drifto94 )  /* (c) 1994 Visco */
//N DRIVER( janjans1 )  /* (c) 1996 Visco */
    DRIVER( stmblade )  /* (c) 1996 Visco */
//N DRIVER( jsk )       /* (c) 1997 Visco */
//N DRIVER( koikois2 )  /* (c) 1997 Visco */
//N DRIVER( mslider )   /* (c) 1997 Visco / Datt Japan */
//N DRIVER( ryorioh )   /* (c) 1998 Visco */
//N DRIVER( janjans2 )  /* (c) 2000 Visco */
//N DRIVER( vasara )    /* (c) 2000 Visco */
//N DRIVER( vasara2 )   /* (c) 2001 Visco */
//- DRIVER( vasara2a )  /* (c) 2001 Visco */
    DRIVER( ultrax )    /* (c) 1995 Banpresto */
    DRIVER( gdfs )      /* (c) 1995 Banpresto */
//U DRIVER( jclub2 )    /* (c) 199? Seta */
//# DRIVER( jclub2o )   /* (c) 199? Seta */
//N DRIVER( darkhors )  /* bootleg of Jockey Club II */
    /* ST-0016 based games (ST-0016 is a z80 / gfx / sound all in one) */
    /* plain ST-0016 */
//N DRIVER( renju )     /* (c) 1994 Visco */
//N DRIVER( nratechu )  /* (c) 1996 Seta */
    /* R3000 + ST-0016 */
//N DRIVER( srmp5 )     /* (c) 199? Seta */
//N DRIVER( speglsht )  /* (c) 1994 Seta */
    /* V810 + ST-0016 */
//# DRIVER( mayjinsn )  /* (c) 1994 Seta */
//N DRIVER( mayjisn2 )  /* (c) 1994 Seta */
//N DRIVER( koikois )   /* (c) 1995 Seta */
    /* Seta System S12 */
//N DRIVER( srmp6 )     /* (c) 1996 Seta (Japan) */
    /* Seta Aleck64 and similar (N64 based) */
//U DRIVER( aleck64 )   /* (c) 1998 Nintendo/Seta */
//# DRIVER( 11beat )    /* (c) 1998 Hudson */
//# DRIVER( mtetrisc )  /* (c) 1998 Capcom */
//U DRIVER( starsldr )  /* (c) 1998 Hudson/Seta */
//N DRIVER( vivdolls )  /* (c) 1998 Visco */
...
//N DRIVER( ohmygod )   /* (c) 1993 Atlus (Japan) */
//N DRIVER( naname )    /* (c) 1994 Atlus (Japan) */
...
//N DRIVER( ikki )      /* TVG17 (c) 1985 Sun Electronics (Japan) */
//- DRIVER( farmer )    /* TVG17 (c) 1985 Sun Electronics */
//N DRIVER( shanghai )  /* (c) 1988 Sunsoft (Sun Electronics) */
//N DRIVER( shangha2 )  /* (c) 1989 Sunsoft (Sun Electronics) */
//N DRIVER( kothello )  /* (c) 1990 Success */
//N DRIVER( shangha3 )  /* (c) 1993 Sunsoft */
//N DRIVER( heberpop )  /* (c) 1994 Sunsoft / Atlus */
//N DRIVER( blocken )   /* (c) 1994 KID / Visco */
/*
Other Sun games
...
*/
    ...
    /* SunA games */
#ifdef __GAME__SUNA__
//N DRIVER( goindol )   /* (c) 1987 Sun a Electronics [NbN: not working, "homo" is the same game] */
...
//N DRIVER( sunaq )     /* (c) 1994 SunA */
    DRIVER( bssoccer )  /* (c) 1996 SunA */
    DRIVER( uballoon )  /* (c) 1996 SunA */
    DRIVER( homo )      /* bootleg */
#endif
    /* Dooyong games */
#ifdef __GAME__DOOYONG__
//N DRIVER( gundealr )  /* (c) 1990 Dooyong */
...
#ifdef __GAME__TONG__
    DRIVER( beezer )    /* (c) 1982 */
//- DRIVER( beezer1 )   /* (c) 1982 */
#endif

    /* Comad games */
#ifdef __GAME__COMAD__
...
#ifdef __GAME__KANEKO__
//N DRIVER( fantasia )  /* (c) 1994 Comad & New Japan System */
//N DRIVER( supmodel )  /* (c) 1994 Comad & New Japan System */
//N DRIVER( newfant )   /* (c) 1995 Comad & New Japan System */
//N DRIVER( fantsy95 )  /* (c) 1995 Hi-max Technology Inc. */
//N DRIVER( zipzap )    /* (c) 1995 Barko Corp */
//N DRIVER( missw96 )   /* (c) 1996 Comad */
//- DRIVER( missmw96 )  /* (c) 1996 Comad */
//N DRIVER( fantsia2 )  /* (c) 1997 Comad */
//- DRIVER( fantsia2a ) /* (c) 1997 Comad */
//N DRIVER( wownfant )  /* (c) 2002 Comad */
//N DRIVER( galhustl )  /* (c) 1997 ACE International */
#endif

    /* Playmark games */
#ifdef __GAME__PLAYMARK__
...
//N DRIVER( sderby )    /* (c) 1996 */
//# DRIVER( pmroulet )
//N DRIVER( spacewin )
#endif 

    /* Pacific Novelty games */
#ifdef __GAME__PACIFIC__
...
//N DRIVER( poitto )    /* (c) 1993 Metro / Able Corp. */
//N DRIVER( dharma )    /* (c) 1994 */
//- DRIVER( dharmak )   /* (c) 1994 */
//N DRIVER( lastfort )  /* (c) 1994 */
//- DRIVER( lastforte ) /* (c) 1994 */
//- DRIVER( lastfortk ) /* (c) 1994 */
//- DRIVER( lastfortg ) /* (c) 1994 */
//N DRIVER( toride2g )  /* (c) 1994 */
//- DRIVER( toride2gg ) /* (c) 1994 */
//- DRIVER( toride2j )  /* (c) 1994 */
    DRIVER( gunmast )   /* (c) 1994 */
//N DRIVER( daitorid )  /* (c) 1995 */
//N DRIVER( daitoa )    /* (c) 1995 */
//N DRIVER( dokyusei )  /* (c) 1995 Make Software / Elf / Media Trading */
//N DRIVER( dokyusp )   /* (c) 1995 Make Software / Elf / Media Trading */
    DRIVER( puzzli )    /* (c) 1995 Metro / Banpresto */
//N DRIVER( 3kokushi )  /* (c) 1996 Mitchell */
//N DRIVER( pururun )   /* (c) 1995 Metro / Banpresto */
    DRIVER( balcube )   /* (c) 1996 */
//N DRIVER( mouja )     /* (c) 1996 Etona (Japan) */
    DRIVER( bangball )  /* (c) 1996 Banpresto / Kunihiko Tashiro+Goodhouse */
//- DRIVER( batlbubl )  /* (c) 1996 Banpresto / Kunihiko Tashiro+Goodhouse */
//N DRIVER( gakusai )   /* (c) 1997 MakeSoft */
//N DRIVER( gakusai2 )  /* (c) 1998 MakeSoft */
    DRIVER( blzntrnd )  /* (c) 1994 Human Amusement */
//N DRIVER( gstrik2 )   /* (c) 1996 Human Amusement */
//- DRIVER( gstrik2e )
    DRIVER( hyprduel )  /* (c) 1993 Technosoft (World) */
//- DRIVER( hyprdelj )  /* (c) 1993 Technosoft (Japan) */
//N DRIVER( magerror )  /* (c) 1994 Technosoft (Japan) (Arcade TV Game List - P.100, Left, 13 from Bottom) */
//# DRIVER( puzzlet )   /* (c) 2000 Yunizu Corporation (Japan) */
#endif
    
    /* Venture Line games */
#ifdef __GAME__VENTURE__
...
//- DRIVER( loopinga )  /* (c) 1982 Venture Line + licensed from Video Games */
    ...
    /* Yun Sung games */
#ifdef __GAME__YUNSUNG__
    DRIVER( paradise )  /* (c) >1994 Yun Sung */
    DRIVER( paradlx )   /* (c) >1994 Yun Sung */
//N DRIVER( para2dx )   /* (c) >1994 Yun Sung */
//N DRIVER( tgtball )   /* (c) 1995 Yun Sung */
...
//N DRIVER( magix )     /* (c) 1995 Yun Sung */
//N DRIVER( rocktris )  /* (c) 1994? Yun Sung */
...
//N DRIVER( searchey )  /* (c) 1999 Yun Sung */
//N DRIVER( searchp2 )  /* (c) 1999 Yun Sung */
//N DRIVER( pclubys )   /* (c) 2000 Yun Sung */
//- DRIVER( pclubysa )  /* (c) 2000 Yun Sung */
//N DRIVER( garogun )   /* (c) 2000 Yun Sung */
//N DRIVER( 7ordi )     /* (c) 2002 Yun Sung */
    DRIVER( wondstck )  /* (c) ???? Yun Sung */
#endif
    
    /* Fuuki FG-2 games */
#ifdef __GAME__FUUKI__
    DRIVER( gogomile )  /* (c) 1995 */
//- DRIVER( gogomilej ) /* (c) 1995 (Japan) */
//N DRIVER( pbancho )   /* (c) 1996 (Japan) */
    /* Fuuki FG-3 games */
...
//- DRIVER( multchmpk ) /* (c) 1998 (Korea) */
    DRIVER( mchampdx )  /* (c) 1999 ESD */  /* NbN: crash with "memory_set_bank called for bank 'bank1' with invalid bank entry 10" */
...
#ifdef __GAME__DYNAX__
//N DRIVER( royalmj )   /* (c) 1982 Nichibutsu */
//- DRIVER( openmj )    /* (c) 1982 Nichibutsu */
//- DRIVER( royalmah )  /* Falcon bootleg */
//- DRIVER( janyoup2 )  /* Falcon bootleg */
//N DRIVER( janputer )  /* (c) 1982 Taito */
//# DRIVER( janoh )     /* (c) 1984 Toaplan */
//# DRIVER( janoha )    /* (c) 1984 Toaplan */
//U DRIVER( jansou )    /* (c) 1985 Dyna */
//N DRIVER( jansoua )   /* (c) 1985 Dyna */
//# DRIVER( mjsiyoub )  /* (c) 1986 Visco */
//# DRIVER( mjsenka )   /* (c) 1986 Visco */
//# DRIVER( mjyarou )   /* (c) 1986 Visco / Video System */
//N DRIVER( mjclub )    /* (c) 1986 Xex */
//N DRIVER( daisyari )  /* (c) 1989 Best System */
//N DRIVER( suzume )    /*  ??  (c) 1986 Dyna Electronics */
//N DRIVER( hnayayoi )  /* "02" (c) 1987 Dyna Electronics */
//N DRIVER( dondenmj )  /* "03" (c) 1986 Dyna Electronics */
//N DRIVER( ippatsu )   /*  ??  (c) 1986 Dyna Electronics */
//- DRIVER( hnfubuki )  /* "06" (c) 1987 Dynax */
//N DRIVER( mjdiplob )  /* "07" (c) 1987 Dynax */
//N DRIVER( untoucha )  /* "08" (c) 1987 Dynax */
//N DRIVER( tontonb )   /* "09" (c) 1987 Dynax */
//N DRIVER( makaijan )  /*  ??  (c) 1987 Dynax */
//- DRIVER( hanamai )   /* "16" (c) 1988 Dynax */
//N DRIVER( majs101b )  /* "17" (c) [1988] Dynax */
//N DRIVER( mjapinky )  /* 1988 Dynax */
//N DRIVER( mjdejavu )  /* 1989 Dynax */
//- DRIVER( mjdejav2 )  /* 1989 Dynax */
//N DRIVER( hnkochou )  /* "20" (c) 1989 Dynax */
//N DRIVER( mjderngr )  /* "22" (c) 1989 Dynax */
//- DRIVER( hnoridur )  /* "23" (c) 1989 Dynax */
//N DRIVER( drgpunch )  /* "24" (c) 1989 Dynax */
//N DRIVER( mjfriday )  /* "26" (c) [1989] Dynax */
//N DRIVER( jantouki )  /* "27" Jantouki 1989 Dynax */
//N DRIVER( gekisha )   /* "28" 1989 Dynax */
//N DRIVER( mjifb )     /* "29" 1990 Dynax */
//- DRIVER( mjifb2 )    /* "29" 1990 Dynax */
//- DRIVER( mjifb3 )    /* "29" 1990 Dynax */
//# DRIVER( mjvegas )   /* 1991 Dynax */
//N DRIVER( mjvegasa )  /* 1991 Dynax */
//N DRIVER( cafetime )  /* 1992 Dynax */
//# DRIVER( cafedoll )  /* 1993 Dynax */
//N DRIVER( janptr96 )  /* 1996 Dynax */
//- DRIVER( sprtmtch )  /* "31" (c) 1989 Dynax + Fabtek license */
//N DRIVER( maya )      /* (c) 1994 Promat */
//N DRIVER( inca )      /* (c) 199? ???? */
//N DRIVER( blktouch )  /* (c) Yang Gi Co Ltd. */
//N DRIVER( mcnpshnt )  /* "33" Mahjong Campus Hunting 1990 Dynax */
//N DRIVER( 7jigen )    /* "37" 7jigen no Youseitachi 1990 Dynax */
//N DRIVER( neruton )   /* "45" Neruton Haikujiradan 1990 Dynax */
//N DRIVER( mjcomv1 )   /* 1991 Dynax */
//N DRIVER( shpeng )    /* (c) 1995 WSAC Systems */
//N DRIVER( tenkai )    /* 1991 Dynax */
...
//N DRIVER( htengoku )  /* 1992 Dynax */
//N DRIVER( mjreach )   /* 1994 Dynax */
//N DRIVER( mjdialq2 )  /* "52" (c) 1991 Dynax */
//N DRIVER( yarunara )  /* "55" Mahjong Yarunara 1991 Dynax */
//N DRIVER( mjangels )  /* "61" Mahjong Angels 1991 Dynax */
//N DRIVER( quiztvqq )  /* "64" Quiz TV Gassyuukoku Q&Q 1992 Dynax */
//N DRIVER( mmpanic )   /* "70" 1992 Nakanihon/Taito */
//# DRIVER( quizchq )   /* "73" (c) 1993 Nakanihon */
//# DRIVER( quizchql )  /* "73" (c) 1993 Laxan */
//N DRIVER( funkyfig )  /* "74" (c) 1993 Nakanihon + East Technology */
//N DRIVER( animaljr )  /* "75" 1993 Nakanihon/Taito */
//N DRIVER( hginga )    /*      1994 Dynax */
//N DRIVER( mjmyster )  /* "?7" 1994 Dynax */
//- DRIVER( mjmywrld )  /* "?7" 1994 Dynax */
//N DRIVER( mjmyornt )  /*      1994 Dynax */
//N DRIVER( mjmyuniv )  /*      1994 Dynax */
//N DRIVER( quiz365 )   /* "78" (c) 1994 Nakanihon */
//- DRIVER( quiz365t )  /* "78" (c) 1994 Nakanihon (Taiwan) */
//N DRIVER( rongrong )  /* "80" (c) 1994 Nakanihon */
//- DRIVER( rongrongj ) /* "80" (c) 1994 Nakanihon */
//- DRIVER( rongrongg ) /* "80" (c) 1994 Nakanihon */
//N DRIVER( hparadis )  /*      (c) 1994 Nakanihon */
//N DRIVER( hgokou )    /*      (c) 1995 Nakanihon */
//N DRIVER( mjdchuka )  /*      (c) 1995 Nakanihon */
//# DRIVER( mjtensin )  /* "100" 1995 Dynax */
//N DRIVER( nettoqc )   /* "103" (c) 1995 Nakanihon */
//# DRIVER( majrjhdx )  /* "105" 1996 Dynax */
//N DRIVER( ddenlvrj )  /* "113" (c) 1995 Dynax */
//- DRIVER( ddenlvrk )  /* "113" (c) 1995 Dynax */
//- DRIVER( ddenlovr )  /* "113" (c) 1996 Dynax */
//- DRIVER( ddenlovb )  /* bootleg */
//N DRIVER( hanakanz )  /* "507" 1996 Dynax */
//N DRIVER( akamaru )   /* "501" 1996 Dynax */
//N DRIVER( sryudens )  /* "502" 1996 Dynax / Face */
//N DRIVER( mjflove )   /*       1996 Dynax */
//N DRIVER( hkagerou )  /* "510" Hana Kagerou 1996 Nakanihon */
//N DRIVER( realbrk )   /* "600" Billiard Academy Real Break 1998 (Europe)*/
//- DRIVER( realbrkk )  /* "600" Billiard Academy Real Break 1998 (Korea)*/
//- DRIVER( realbrkj )  /* "523" Billiard Academy Real Break 1998 (Japan)*/
//N DRIVER( dai2kaku )  /* "522" DaiDaiKakumei (Japan)*/
//N DRIVER( mjchuuka )  /* "???" (c) 1998 Dynax */
//N DRIVER( mjreach1 )  /* "526" Mahjong Reach Ippatsu 1998 Nihon System/Dynax */ 
//# DRIVER( cafebrk )   /* "528" Mahjong Cafe Break (C) 1999 Nakanihon / Dynax */
//N DRIVER( jongtei )   /* "532" Mahjong Jong-Tei (C) 1999 Dynax */
//N DRIVER( daimyojn )  /* 2002 Dynax / Techno-Top */
//N DRIVER( pkgnsh )    /* "505" Pachinko Gindama Shoubu 1998 (Japan) */
//N DRIVER( pkgnshdx )  /* "522" Pachinko Gindama Shoubu DX 1998 (Japan) */
//N DRIVER( hjingi )    /* "???" 1990 Dynax */
//N DRIVER( hanayara )  /* "???" */
//N DRIVER( mjelctrn )  /* "???" Mahjong Electron Base parts 2 & 4 */
...
#ifdef __GAME__IGS__
//N DRIVER( goldstar )  /* (c) 198? IGS */
//- DRIVER( goldstbl )  /* (c) 198? IGS */
//- DRIVER( moonlght )  /* bootleg */
//N DRIVER( chry10 )    /* bootleg */
//N DRIVER( chrygld )   /* bootleg */
//# DRIVER( cabaret )   /* (c) 1992 AMT */
//N DRIVER( cpoker )    /* (c) 1993? IGS */
//- DRIVER( cpokert )   /* (c) 1993? Tuning */
//N DRIVER( csk227it )  /* (c) 198? IGS */
//- DRIVER( csk234it )  /* (c) 198? IGS */
//N DRIVER( igs_ncs )   /* (c) 198? IGS */
//N DRIVER( igs_ncs2 )  /* (c) 2000 IGS */
//- DRIVER( spk115it )  /* (c) 199? IGS */
//N DRIVER( spk116it )  /* (c) 199? IGS */
//N DRIVER( jackie )    /* (c) 1993 IGS */
//N DRIVER( pktet346 )  /* (c) 199? IGS */
//N DRIVER( chleague )  /* (c) 199? IGS */
//- DRIVER( chleagul )  /* (c) 199? IGS */
//N DRIVER( number10 )  /* (c) IGS (Board labeled Playmark Srl) */
//- DRIVER( numbr10l )  /* (c) IGS (Board labeled Playmark Srl) */
//N DRIVER( cpokerpk )  /* (c) SGS (bootleg blue board) */
...
//N DRIVER( xymg )      /* (c) 1996 */
	DRIVER( grtwall )	/* (c) 1996 */
//N DRIVER( vbowl )     /* (c) 1996 */
//- DRIVER( vbowlj )    /* (c) 1996 */
//N DRIVER( drgnwrld )  /* (c) 1997 */
...
//# DRIVER( kovj )      /* (c) 1999 */
//N DRIVER( kovsh )     /* (c) 1999 */
//N DRIVER( photoy2k )  /* (c) 1999 */
...
//# DRIVER( killbldp )
//# DRIVER( svg )
//N DRIVER( ncb3 )      /* (c) 199? Dyna Electronics */
//- DRIVER( cb3a )      /* (c) 199? Dyna Electronics */
//- DRIVER( cb3 )       /* (c) 199? Dyna Electronics */
//- DRIVER( cb3b )      /* (c) 199? Dyna Electronics */
//N DRIVER( cmv801 )    /* (c) 198? Corsica */
//N DRIVER( cmv4 )      /* (c) 1992 Dyna Electronics */
//# DRIVER( cmv4a )     /* (c) 1992 Dyna Electronics */
//N DRIVER( cmaster )   /* (c) 1991 Dyna Electronics */
//- DRIVER( cmasterb )  /* (c) 1991 Dyna Electronics */
//- DRIVER( cmasterc )  /* (c) 1991 Dyna Electronics */
//N DRIVER( cmast91 )   /* (c) 1991 Dyna Electronics */
//N DRIVER( skill98 )   /* (c) 1998 Amcoe */
//N DRIVER( match98 )   /* (c) 1998 Amcoe */
//N DRIVER( schery97 )  /* (c) 1998 Amcoe */
//- DRIVER( schery97a ) /* (c) 1998 Amcoe */
//N DRIVER( roypok96 )  /* (c) 1996 Amcoe */
//- DRIVER( roypok96a ) /* (c) 1996 Amcoe */
//- DRIVER( roypok96b ) /* (c) 1996 Amcoe */
//N DRIVER( pokonl97 )  /* (c) 1997 Amcoe */
...
//N DRIVER( ns8lines )  /* unknown */
//N DRIVER( ladylinr )  /* (c) 198? TAB Austria */
//N DRIVER( kkojnoli )  /* 198? south korean hack */
//# DRIVER( wcat3 )
//# DRIVER( mtonic )    /* 198? (c) Tonic */
#endif

    /* RamTek games */
#ifdef __GAME__RAMTEK__
//N DRIVER( hitme )     /* (c) 1976 Ramtek */
...
//- DRIVER( brickyrd )  /* (c) 1976 Ramtek */
    ...
    /* U.S. Games games */
#ifdef __GAME__MISC__
//N DRIVER( usg32 )     /* (c) 1987 */
//- DRIVER( usg82 )     /* (c) 1988 */
//N DRIVER( usg83 )     /* (c) 1988 */
//- DRIVER( usg83x )    /* (c) 1988 */
//N DRIVER( usg182 )    /* (c) 1989 */
//N DRIVER( usg185 )    /* (c) 1991 */
//N DRIVER( usg252 )    /* (c) 1992 */
#endif

    /* Sanritsu games */
#ifdef __GAME__SANRITSU__
...
//N DRIVER( jantotsu )  /* (c) 1983 Sanritsu */
//N DRIVER( appoooh )   /* (c) 1984 Sega,  made by Sanritsu */
...
//N DRIVER( mjkjidai )  /* (c) 1986 Sanritsu */
//N DRIVER( chinsan )   /* (c) 1987 Sanritsu */
//N DRIVER( mayumi )    /* (c) 1988 Victory L.L.C.,  made by Sanritsu */
#endif

    /* Rare games */
#ifdef __GAME__RARE__
//N DRIVER( xtheball )  /* (c) 1991 Rare */
    DRIVER( btoads )    /* (c) 1994 Rare */
//N DRIVER( kinst )     /* (c) 1994 Rare */
//- DRIVER( kinst14 )   /* (c) 1994 Rare */
//- DRIVER( kinst13 )   /* (c) 1994 Rare */
//- DRIVER( kinstp )    /* (c) 1994 Rare */
//N DRIVER( kinst2 )    /* (c) 1995 Rare */
...
//N DRIVER( pbillrd )   /* (c) 1987 Nihon System */
...
//# DRIVER( countrb2 )  /* (c) 1988 bootleg */
    ...
    /* Alba games */
#ifdef __GAME__ALBA__
//N DRIVER( rmhaihai )  /* (c) 1985 Alba */
//- DRIVER( rmhaihib )  /* (c) 1985 Alba */
//N DRIVER( rmhaijin )  /* (c) 1986 Alba */
//N DRIVER( rmhaisei )  /* (c) 1986 Visco */
//N DRIVER( themj )     /* (c) 1987 Visco */
//N DRIVER( hanaroku )  /* (c) 1988 Alba */
//N DRIVER( yumefuda )  /* (c) 198? Alba */
#endif
    
    /* Home Data games */
#ifdef __GAME__MISC__
//N DRIVER( hourouki )  /* (c) 1987 Home Data */
//N DRIVER( mhgaiden )  /* (c) 1987 Home Data */
//# DRIVER( mirderby )  /* (c) 1988 Home Data? */
//N DRIVER( mjhokite )  /* (c) 1988 Home Data */
//N DRIVER( mjclinic )  /* (c) 1988 Home Data */
//N DRIVER( mrokumei )  /* (c) 1988 Home Data */
//N DRIVER( reikaids )  /* (c) 1988 Home Data */
//N DRIVER( mjkojink )  /* (c) 1989 Home Data */
//N DRIVER( vitaminc )  /* (c) 1989 Home Data */
//N DRIVER( mjyougo )   /* (c) 1989 Home Data */
//N DRIVER( lemnangl )  /* (c) 1990 Home Data */
//N DRIVER( mjkinjas )  /* (c) 1991 Home Data */
    DRIVER( battlcry )  /* (c) 1991 Home Data */
//N DRIVER( jogakuen )  /* (c) 1992 Windom corporation */
//N DRIVER( mjikaga )   /* (c) 1991 Mitchell */
//N DRIVER( mjprivat )  /* (c) 1991 Matoba */
#endif
...
//- DRIVER( hiryuken )  /* (c) 1985 Taito */
    ...
    /* Tatsumi Games */
#ifdef __GAME__TATSUMI__
//N DRIVER( kingdrby )  /* (c) 1981 Tatsumi */
...
//N DRIVER( ppmast93 )  /* (c) 1993 Electronic Devices S.R.L. */
//N DRIVER( twins )     /* (c) 1994 */
...
//N DRIVER( pzletime )
    ...
    /* Arcadia System */
#ifdef __GAME__AMIGA__
//U DRIVER( ar_bios )
//N DRIVER( ar_airh )   /* (c) 1988 */
//N DRIVER( ar_airh2 )  /* (c) 1988 */
//N DRIVER( ar_bowl )   /* (c) 1988 */
//N DRIVER( ar_dart )   /* (c) 1987 */
//# DRIVER( ar_dart2 )  /* (c) 1987 */
//N DRIVER( ar_fast )   /* (c) 1988 */
//N DRIVER( ar_ldrb )   /* (c) 1988 */
//- DRIVER( ar_ldrba )  /* (c) 1988 */
//N DRIVER( ar_ninj )   /* (c) 1987 */
//- DRIVER( ar_ninj2 )  /* (c) 1987 */
//N DRIVER( ar_rdwr )   /* (c) 1988 */
//N DRIVER( ar_sdwr )   /* (c) 1988 */
//- DRIVER( ar_sdwr2 )  /* (c) 1988 */
//N DRIVER( ar_socc )   /* (c) 1989 */
//N DRIVER( ar_spot )   /* (c) 1990 */
//N DRIVER( ar_sprg )   /* (c) 1987 */
//N DRIVER( ar_xeon )   /* (c) 1988 */
    /* Sente Super System */
//# DRIVER( mquake )    /* (c) 1987 */
    /* Other Amiga-based games */
//N DRIVER( upscope )   /* (c) 1986 Grand products */
//U DRIVER( cd32 )      /* (c) 1993 */
//N DRIVER( cndypuzl )  /* (c) 1995 */
//N DRIVER( haremchl )  /* (c) 1995 */
//N DRIVER( lsrquiz )   /* (c) 1995 */
//N DRIVER( lsrquiz2 )  /* (c) 1995 */
//N DRIVER( mgprem11 )  /* (c) 1995 */
//N DRIVER( lasstixx )  /* (c) 1995 */
//N DRIVER( mgnumber )  /* (c) 1995 */
...
//N DRIVER( escounts )  /* 1990 BFM */
//N DRIVER( trebltop )  /* 1991 BFM */
//# DRIVER( beeline )   /* 1991 BFM */
//N DRIVER( quizvadr )  /* 1991 BFM */
//N DRIVER( qos )       /* 1992 BFM */
//- DRIVER( qosa )      /* 1992 BFM */
//- DRIVER( qosb )      /* 1992 BFM */
    /* Scorpion 2+Video Board Games */
//- DRIVER( qntoondo )  /* 1993 */
//N DRIVER( quintoon )  /* 1993 */
//# DRIVER( quintond )  /* 1993 */
//- DRIVER( quintono )  /* 1993 */
//N DRIVER( qntoond )   /* 1993 */
//N DRIVER( pokio )     /* 1994 */
//N DRIVER( slotsnl )   /* 1995 */
//N DRIVER( paradice )  /* 1995 */
//N DRIVER( pyramid )   /* 1996 */
//N DRIVER( sltblgtk )  /* 1996 */
//N DRIVER( sltblgpo )  /* 1996 */
//- DRIVER( sltblgp1 )  /* 1996 */
//N DRIVER( gldncrwn )  /* 1997 */
    /* Scorpion 2 */
//# DRIVER( m_brkfst )
//N DRIVER( m_bdrwho )
//- DRIVER( m_bdrwh1 )
...
#ifdef __GAME__BARCREST__
//N DRIVER( mpu4utst )
//N DRIVER( mpu4tst2 )
//N DRIVER( mpu4met0 )
    /* MPU4 Non-Video SWPs */
//N DRIVER( connect4 )  /* Dolbeck Systems */
    /* MPU4+Video Board Games */
//U DRIVER( bctvidbs )
//N DRIVER( dealem )    /* 1987 */
...
//N DRIVER( tenup )     /* (c) 1988 */
//- DRIVER( tenup3 )    /* (c) 1988 */
    /* JPM System 5 + video expansion 2 Games */
//N DRIVER( monopoly )  /* (c) 1994 */
//- DRIVER( monoplcl )  /* (c) 1995 */
//N DRIVER( monopldx )  /* (c) 1995 */
    /* JPM Impact Games */
//N DRIVER( cluedo )    /* (c) 1995 */
//- DRIVER( cluedo2c )  /* (c) 1995 */
//- DRIVER( cluedo2 )   /* (c) 1995 */
//N DRIVER( trivialp )  /* (c) 1996 */
//N DRIVER( scrabble )  /* (c) 1997 */
//N DRIVER( hngmnjpm )  /* (c) 1998 */
//N DRIVER( coronatn )  /* (c) 1999 */
//# DRIVER( m_tbirds )
#endif
...
//N DRIVER( sshooter )  /* (c) 1998 P&P Marketing */
...
//N DRIVER( gotcha )    /* (c) 1997 Dongsung + "presented by Para" */
//- DRIVER( ppchamp )   /* (c) 1997 Dongsung + "presented by Para" */
//N DRIVER( amerdart )  /* (c) 1989 Ameri Corporation */
//- DRIVER( amerdart2 ) /* (c) 1989 Ameri Corporation */
//N DRIVER( coolpool )  /* (c) 1992 Catalina Games */
//N DRIVER( 9ballsht )  /* (c) 1993 E-Scape EnterMedia + "marketed by Bundra Games" */
...
//N DRIVER( mspuzzle )  /* (c) 1994 Min Corp. */
//# DRIVER( mspuzzlen ) /* (c) 1994 Min Corp. */
//N DRIVER( msbingo )   /* (C) 1994 Min Corp. */
//N DRIVER( dblpoint )  /* (c) 1995 Min Corp. */
//- DRIVER( dblpointd ) /* (c) 1995 Dong Bang Electron */
//N DRIVER( statusbj )  /* (c) 1981 Status Games */
//# DRIVER( tripdraw )  /* (c) 1981 Status Games */
//N DRIVER( funcsino )  /* (c) 1981 Status Games */
//N DRIVER( hangman )   /* (c) 1984 Status Games */
//N DRIVER( trivquiz )  /* (c) 1984 Status Games */
//N DRIVER( statriv2 )  /* (c) 1984 Status Games */
//- DRIVER( statriv2v ) /* (c) 1984 Status Games */
//N DRIVER( statriv4 )  /* (c) 1985 Status Games */
//N DRIVER( sextriv )   /* (c) 1985 Status Games */
//# DRIVER( quaquiz2 )  /* (c) 1985 Status Games */
//N DRIVER( supertr2 )  /* (c) 1986 Status Games */
//N DRIVER( supertr3 )  /* (c) 1986 Status Games */
...
//N DRIVER( crgolf )    /* (c) 1984 Nasco Japan */
...
//N DRIVER( crgolfhi )  /* (c) 1984 Nasco Japan */
//N DRIVER( truco )     /* (c) 198? Playtronic SRL */
...
//N DRIVER( dquizgo2 )  /* (c) 2000 Semicom */
    DRIVER( misncrft )  /* (c) 2000 Sun */
//N DRIVER( xfiles )    /* (c) 1999 dgPIX Entertainment Inc */
    DRIVER( kdynastg )  /* (c) 1999 EZ Graphics */
//N DRIVER( fmaniac3 )  /* (c) 2002 Saero Entertainment */
//N DRIVER( promutrv )  /* (c) 1985 Enerdyne Technologies Inc */
...
//N DRIVER( dcheese )   /* (c) 1993 HAR */
//N DRIVER( lottof2 )   /* (c) 1993 HAR */
//N DRIVER( fredmem )   /* (c) 1994 Coastal Amusements */
...
//N DRIVER( cecmatch )  /* (c) 1993 Coastal Amusements */
...
//N DRIVER( othello )   /* (c) 1984 Success */
//N DRIVER( sothello )  /* (c) 1986 Success / Fujiwara */
...
//N DRIVER( poker41 )   /* (c) 1983 Game-A-Tron */
//N DRIVER( pulltabs )  /* (c) 1983 Game-A-Tron */
#endif

#ifdef __GAME__GREYHND__
//N DRIVER( gt507uk )   /* (c) 1986 Grayhound Electronics */
//N DRIVER( gt5 )       /* (c) 1984 Grayhound Electronics */
//N DRIVER( gtsers8 )   /* (c) 1984 Greyhound Electronics */
...
//N DRIVER( reelfun )   /* (c) 1986 Grayhound Electronics */
//N DRIVER( findout )   /* (c) 1987 [Elettronolo] */
//N DRIVER( quiz )      /* (c) 1986 Italian bootleg */
//N DRIVER( quiz211 )   /* (c) 1986 Italian bootleg */
//N DRIVER( jokpoker )  /* (c) 1982 Greyhound Electronics */
//- DRIVER( jokpokera ) /* (c) 1982 Greyhound Electronics */
//N DRIVER( superbwl )  /* (c) 1982 Greyhound Electronics */
//N DRIVER( amuse )     /* (c) 1982 Greyhound Electronics */
//N DRIVER( gs4002 )    /* (c) 1982 G.E.I. */
//- DRIVER( gs4002a )   /* (c) 1982 G.E.I. */
//N DRIVER( gepoker )   /* (c) 1984 Greyhound Electronics */
//- DRIVER( gepoker1 )  /* (c) 1984 Greyhound Electronics */
//- DRIVER( gepoker2 )  /* (c) 1984 Greyhound Electronics */
//N DRIVER( gtsers1 )   /* (c) 1984 Greyhound Electronics */
...
//N DRIVER( turbosub )  /* (c) 1985 Entertainment Sciences */
...
//# DRIVER( magicardb ) /* (c) 199? */
    ...
    /* Funworld */
#ifdef __GAME__MISC__
//N DRIVER( jollycrd )  /* (c) 1985 TAB-Austria */
...
//N DRIVER( bigdeal )   /* (c) 1986 Funworld */
//- DRIVER( bigdealb )  /* (c) 1986 Funworld */
//- DRIVER( jolycdat )  /* (c) 1986 Funworld */
//N DRIVER( cuoreuno )  /* (c) 1996 C.M.C. */
//N DRIVER( elephfam )  /* (c) 1997 C.M.C. */
//- DRIVER( elephfmb )  /* (c) 1996 C.M.C. */
//N DRIVER( pool10 )    /* (c) 1996 C.M.C. */
//- DRIVER( pool10b )   /* (c) 1996 C.M.C. */
//- DRIVER( pool10c )   /* (c) 1996 C.M.C. */
//- DRIVER( pool10d )   /* (c) 1997 C.M.C. */
//N DRIVER( tortufam )  /* (c) 1997 C.M.C. */
//N DRIVER( potgame )   /* (c) 1996 C.M.C. */
//N DRIVER( bottle10 )  /* (c) 1996 C.M.C. */
//- DRIVER( bottl10b )  /* (c) 1996 C.M.C. */
//N DRIVER( royalcrd )  /* (c) 1991 TAB-Austria */
...
//# DRIVER( photoply )
    ...
    /* Sandii' */
#ifdef __GAME__MISC__
//N DRIVER( snookr10 )  /* (c) 1998 Sandii' */
//N DRIVER( apple10 )   /* (c) 1998 Sandii' */
//- DRIVER( tenballs )  /* 1997 unknown */
#endif


#ifdef __GAME__MISC__
//N DRIVER( vroulet )   /* (c) 1989 World Game */
//N DRIVER( rcasino )   /* (c) 1984 Dyna Electronics */
//N DRIVER( ampoker2 )  /* (c) 1990 Novomatic */
...
//N DRIVER( sigmapkr )  /* (c) 1995 Sigma */
//N DRIVER( sigma2k )   /* (c) 2000 Sigma */
//N DRIVER( sidewndr )  /* (c) 1981? ACE */
...
//N DRIVER( quizmstr )  /* (c) 1985 Coinmaster */
...
//N DRIVER( magic10 )   /* (c) 1995 A.W.P. Games */
...
//N DRIVER( sgsafari )  /* (c) 1996 New Impeuropex Corp. */
//N DRIVER( galaxi )    /* (c) 2000 BRL S.R.L. Bologna */
//N DRIVER( magjoker )  /* (c) 2000 BRL S.R.L. Bologna */
//N DRIVER( dwarfd )    /* (c) 198? Electro-Sports */
//N DRIVER( trvquest )  /* (c) 1984 Sunn / Techstar */
//# DRIVER( wheelfir )  /* (c) 199? TCH */
//# DRIVER( littlerb )  /* (c) 1993 TCH */
//# DRIVER( tattack )   /* (c) 198? Shonan */
//N DRIVER( mosaicf2 )  /* (c) 1999 F2 System */
//N DRIVER( finalgdr )  /* (c) 2001 Semicom */
    DRIVER( wyvernwg )  /* (c) 2001 Semicom / Game Vision */
//# DRIVER( rbmk )      /* (c) 1995 GMS */
//N DRIVER( go2000 )    /* (c) 2000 SA */
    DRIVER( mirax )     /* (c) 1985 Current Technologies */
//- DRIVER( miraxa )    /* (c) 1985 Current Technologies */
#endif
#ifdef __GAME__SUBSINO__    
//N DRIVER( victor5 )   /* (c) 1990 Subsino */
//N DRIVER( victor21 )  /* (c) 1990 Subsino */
//N DRIVER( crsbingo )  /* (c) 1991 Subsino */
//N DRIVER( sharkpy )   /* (c) 1993 Subsino */
//- DRIVER( sharkpya )  /* (c) 1993 Subsino */
//N DRIVER( smoto20 )   /* (c) 1996 Subsino */
//- DRIVER( smoto16 )   /* (c) 1996 Subsino */
//N DRIVER( saklove )   /* (c) 1998 Subsino */
//N DRIVER( bishjan )   /* (c) 1999 Subsino */
...
//N DRIVER( goodluck )  /* Unknown */
//# DRIVER( royale )    /* Unknown */
//# DRIVER( royalea )   /* Unknown */
//N DRIVER( witchcrd )  /* 1991, Video Klein */
//N DRIVER( witchcda )  /* 1991, Unknown */
//N DRIVER( witchcdb )  /* 1991, Unknown */
//N DRIVER( witchcdc )  /* 1991, Unknown */
//N DRIVER( witchcdd )  /* 1991, Unknown */
//# DRIVER( witchcde )  /* 1994, Unknown */
//N DRIVER( witchcdf )  /* (c) 1991 PlayMan */
//N DRIVER( sloco93 )   /* 1993, Unknown */
//- DRIVER( sloco93a )  /* 1993, Unknown */
//N DRIVER( maverik )   /* 198?, Unknown */
//N DRIVER( brasil89 )  /* 1989, Unknown */
//N DRIVER( poker91 )   /* 1991, Unknown */
//N DRIVER( bsuerte )   /* 1990, Unknown */
...
//- DRIVER( bsuerteu )  /* 1991, Unknown */
    ...
    /* Cal Omega */
#ifdef __GAME__MISC__
//N DRIVER( comg074 )   /* (c) 1981 Cal Omega Inc. */
//N DRIVER( comg076 )   /* (c) 1981 Cal Omega Inc. */
...
//N DRIVER( comg128 )   /* (c) 1982 Cal Omega Inc. */
...
//N DRIVER( comg175 )   /* (c) 1984 Cal Omega / Casino Electronics Inc. */
...
//N DRIVER( comg239 )   /* (c) 1985 Cal Omega / Casino Electronics Inc. */
...
//N DRIVER( elgrande )  /* (c) 1982 Tuni Electro Service / E.T. Marketing */
//N DRIVER( jjpoker )   /* (c) 1983 Enter-Tech */
//- DRIVER( jjpokerb )  /* (c) 1983 Enter-Tech */
//N DRIVER( ssipkr24 )  /* (c) 1988 SSI */
...
//N DRIVER( trvhang )   /* (c) 1984 SMS MFG CORP */
//# DRIVER( trvhanga )  /* (c) 1984 SMS MFG CORP */
//N DRIVER( sureshot )  /* (c) 1985 SMS MFG CORP */
//N DRIVER( skylncr )   /* (c) 1995 Bordun International */
//N DRIVER( butrfly )   /* (c) 1995 Bordun International */
//N DRIVER( madzoo )    /* (c) 1995 Bordun International */
//# DRIVER( leader )    /* Bootleg? */
//N DRIVER( livequiz )  /* (c) 1999 Andamiro */
//# DRIVER( cowrace )   /* (c) 20?? hack */
    DRIVER( discoboy )  /* (c) 1993 Soft Art Co. */
//# DRIVER( pangofun )  /* (c) 1995 InfoCube */
//# DRIVER( 2mindril )  /* (c) 1993 Taito */
//N DRIVER( koikoi )    /* (c) 1983 Kiwako */
//N DRIVER( good )      /* (c) 1983 Kiwako */
    DRIVER( filetto )   /* (c) 1990 Novamatic */
//N DRIVER( quizo )     /* (c) 1985 Seoul Coin Corp. */
//- DRIVER( quizoa )    /* (c) 1985 Seoul Coin Corp. */
    DRIVER( gstream )   /* (c) 2002, Oriental Soft Japan */
//# DRIVER( miniboy7 )  /* (c) 1983, Bonanza Enterprises */
//N DRIVER( 39in1 )     /* MAME based bootleg */
//# DRIVER( 48in1 )     /* MAME based bootleg */
//# DRIVER( 48in1a )        /* MAME based bootleg */
//N DRIVER( kingpin )   /* (c) 1983 American Communications Laboratories Inc. */
//N DRIVER( kingpinm )  /* (c) 1983 American Communications Laboratories Inc. */
...
//N DRIVER( peset038 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0043 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0065 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0158 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0188 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0250 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0447 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pepp0516 )  /* (c) 1987 IGT - International Gaming Technology */
//N DRIVER( pebe0014 )  /* (c) 1994 IGT - International Gaming Technology */
//N DRIVER( peke1012 )  /* (c) 1994 IGT - International Gaming Technology */
//N DRIVER( peps0014 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0022 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0043 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0045 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0308 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0615 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( peps0716 )  /* (c) 1996 IGT - International Gaming Technology */
//N DRIVER( pex2069p )  /* (c) 1995 IGT - International Gaming Technology */
//N DRIVER( pexp0019 )  /* (c) 1995 IGT - International Gaming Technology */
//N DRIVER( pexp0112 )  /* (c) 1995 IGT - International Gaming Technology */
//N DRIVER( pexs0006 )  /* (c) 1997 IGT - International Gaming Technology */
//N DRIVER( pexmp006 )  /* (c) 1997 IGT - International Gaming Technology */
//N DRIVER( pexmp017 )  /* (c) 1997 IGT - International Gaming Technology */
//N DRIVER( pexmp024 )  /* (c) 1997 IGT - International Gaming Technology */
//N DRIVER( mirage )    /* (c) 1994 Mitchell */
    DRIVER( dominob )   /* (c) 1996 Wonwoo Systems */
//N DRIVER( jongkyo )   /* (c) 1985 Kiwako */
...
//N DRIVER( re900 )     /* (c) 1993 Entretenimientos GEMINIS */
//N DRIVER( bs94 )      /* (c) 1994 Entretenimientos GEMINIS */
//# DRIVER( jokrwild )  /* (c) 1988 Sigma */
//N DRIVER( pesadelo )  /* (c) 1989 Forte II Games */
//N DRIVER( spool99 )   /* (c) 1998 Electronic Projects */
//- DRIVER( spool99a )  /* (c) 1998 Electronic Projects */
//# DRIVER( 4roses )    /* (c) 1999 Unknown */
//# DRIVER( 4rosesa )   /* (c) 1999 Unknown */
//N DRIVER( big10 )     /* (c) 198? Unknown */
...
#ifdef __GAME__MISC__
//N DRIVER( videopkr )  /* (c) 1984 InterFlip */
...
#ifdef __GAME__MISC__
//N DRIVER( newmcard )  /* (c) 19?? unknown */
//N DRIVER( brasil )    /* (c) 2000 unknown */
//- DRIVER( fashion )   /* (c) 2000 unknown */
//N DRIVER( ciclone )   /* (c) 2000 unknown */
#endif

    /* V30-based italian gambling games */
#ifdef __GAME__MISC__
//N DRIVER( tour4000 )  /* (c) 2000 High Video */
//N DRIVER( cfever40 )  /* (c) 2000 High Video */
//N DRIVER( cfever50 )  /* (c) 2000 High Video */
//N DRIVER( tour4010 )  /* (c) 2000 High Video */
//N DRIVER( cfever51 )  /* (c) 2000 High Video */
//N DRIVER( cfever61 )  /* (c) 2000 High Video */
//N DRIVER( cfever1k )  /* (c) 2000 High Video */
//N DRIVER( girotutt )  /* (c) 2000 High Video */
#endif
...
//# DRIVER( ilpag )     /* (c) 199? unknown */
    ...
    /* Sure games */
#ifdef __GAME__MISC__
//N DRIVER( mil4000 )   /* (c) 2000 Sure Milano */
...
//# DRIVER( supjolly )  /* (c) 200? unknown */
    ...
    /* Astro Corp. */
#ifdef __GAME__MISC__
//N DRIVER( showhand )  /* (c) 1999? Astro Corp. */
...
//N DRIVER( lucky74 )   /* (c) 1988 Wing Co. Ltd */
//# DRIVER( lucky74a )  /* (c) 1988 Wing Co. Ltd */
//N DRIVER( lucky8 )    /* (c) 1989 Wing Co. Ltd */
...
//N DRIVER( tighook )   /* (c) 2004 Amcoe - Tiger Hook */
...
//N DRIVER( fb2gen )    /* (c) 2004 Amcoe - Fruit Bonus 2nd Generation */
...
//N DRIVER( fb2nd )     /* (c) 2004 Amcoe - Fruit Bonus 2nd Edition */
...
//N DRIVER( fb4 )       /* (c) 2004 Amcoe - Fruit Bonus 2004 */
...
//N DRIVER( fb5 )       /* (c) 2005 Amcoe - Fruit Bonus 2005 */
//- DRIVER( fb5c )      /* (c) 2005 Amcoe */
//- DRIVER( fb5d )      /* (c) 2005 Amcoe */
//- DRIVER( fb5v )      /* (c) 2005 Amcoe */
//N DRIVER( fb6 )       /* (c) 200? Amcoe - Fruit Bonus '06 - 10th anniversary */
...
//N DRIVER( fb6se )     /* (c) 200? Amcoe - Fruit Bonus 2006 Special Edition */
...
//N DRIVER( act2000 )   /* (c) 1999 Amcoe - Action 2000 */
...
//N DRIVER( ch2000 )    /* (c) 2000 Amcoe - Fruit Bonus 2000 / New Cherry 2000 */
...
//N DRIVER( pir2001 )   /* (c) 2001 Amcoe - Pirate 2001 */
...
//N DRIVER( pir2002 )   /* (c) 2001 Amcoe - Pirate 2002 */
...
//N DRIVER( classice )  /* (c) 2004 Amcoe - Classic Edition */
...
//N DRIVER( seawld )    /* (c) 200? Amcoe - Sea World */
//- DRIVER( seawldd1 )  /* (c) 200? Amcoe */
//N DRIVER( moneymac )  /* (c) 200? Amcoe - Money Machine */
...
//# DRIVER( spielbud )  /* (c) 1985 ADP */
    ...
    /* Hi-Soft */
#ifdef __GAME__MISC__
//N DRIVER( himesiki )  /* (c) 1989 Hi-Soft */
#endif
    
    /* Draw Poker Hi-Lo based */
#ifdef __GAME__MISC__
//N DRIVER( norautp )   /* (c) 1988? Noraut Ltd (slot machine) */
//- DRIVER( norautjp )  /* (c) 1988? Noraut Ltd */
//N DRIVER( norautrh )  /* (c) 1988? Noraut Ltd (slot machine) */
...
//- DRIVER( pirate2e )  /* (c) 2006 */
    ...
    /* Island 2 */
//N DRIVER( island2 )   /* (c) 2006 */
//- DRIVER( island2a )  /* (c) 2006 */

    /* Keks */
//N DRIVER( keks )      /* (c) 2006 */
//- DRIVER( keksa )     /* (c) 2006 */
//- DRIVER( keksb )     /* (c) 2006 */
//- DRIVER( keksc )     /* (c) 2006 */
